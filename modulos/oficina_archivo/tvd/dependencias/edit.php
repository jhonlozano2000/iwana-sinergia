...
$Dependencia = DependenciaTVD::Buscar(2, $_REQUEST['id'], "", "", "");
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Ofi. Archivo, TVD Dependencias :::...</title>
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">TVD - Dependencias.</a> </li>
                </ul>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row form-row">
                                            <div class="col-md-12">
                                                ...
                                                value="<?php echo $Dependencia -> getNom_Dependencia(); ?>">
                                            </div>
                                        </div>
                                        <div class="row form-row">
                                            <div class="col-md-12">
                                                <textarea name="observa" rows="3" class="form-control" id="observa"
                                                placeholder="Observaciones si las hay..."><?php echo trim($Dependencia -> getObserva()); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row form-row">
                                            <div class="col-md-8">
                                                <div class="checkbox check-success">
                                                    <?php
                                                    if($Dependencia->getActi() == 1){
                                                        $checked = "checked";
                                                    }else{
                                                        $checked = "";
                                                    }
                                                    ?>
                                                    <input name="acti" id="acti" type="checkbox" id="acti" value="1" <?php echo $checked; ?>>
