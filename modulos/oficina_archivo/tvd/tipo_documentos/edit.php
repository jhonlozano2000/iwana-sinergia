...
$TipoDocumental = TipoDocumentoTVD::Buscar(1, $_REQUEST['id'], "");
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Oficina de Archivo, TVD Tipos documentales :::...</title>
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="#" class="active">Oficina de Archivo, TVD Tipos Documentales.</a>
                    </li>
                </ul>
                ...
                <form role="form" name="FrmDatos" id="FrmDatos">
                    ...
                    <input name="id_tipodoc" id="id_tipodoc" type="hidden" value="<?php echo $TipoDocumental -> get_Id(); ?>">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="grid simple">
                                <div class="grid-body no-border">
                                    <div class="row column-seperation">
                                        <div class="col-md-6">
                                           <h4><span class="text-warning">Editar</span>, 
                                               Información básica del tipo de documento
                                           </h4>     
                                           <div class="row form-row">
                                            <div class="col-md-12">
                                                <input name="nom_tipodoc" type="text" class="form-control" id="nom_tipodoc"
                                                placeholder="Nombre del tipo de documeto" value="<?php echo $TipoDocumental -> getNom_TipoDocumento(); ?>">
                                            </div>
                                        </div>
                                        <div class="row form-row">
                                            <div class="col-md-12">
                                               <textarea name="observa" rows="3" class="form-control" id="observa" placeholder="Observaciones si las hay..."><?php echo $TipoDocumental -> getNom_TipoDocumento(); ?></textarea>
                                           </div>
                                       </div>
                                       <div class="row form-row">
                                        <div class="col-md-8">
                            ...
                            <div class="form-actions">
                                <div class="pull-left">
                                    <button class="btn btn-warning btn-cons" type="button" id="BtnEditar" name="BtnEditar"><i class="glyphicon glyphicon-pencil"></i></span> Editar</button>
