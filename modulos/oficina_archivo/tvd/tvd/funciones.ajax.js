$(document).ready(function() {
	...
	$("#id_depen").change(function(){
		...
		if($("#incluir_oficina_trd").val() == 1){
			...
			$.post("../../../varios/combo_oficinas_tvd.php", {
				idDepen: idDepen
			}, function(data){
	...
	$("#id_oficina").change(function(){
		$.post("listar_tvd.php", {
			...
			$("#TblTVD tbody tr").each(function (index){
				var campo1, campo2, campo3;
				$(this).children("td").each(function (index2){
					$(this).remove();
				})
			...
			$('#TblTVD tr:last').after(data);
		});
	});

	$(document).on('click', '.actiTRD', function(event){
		
		var IdTRD = $(this).data("id_tvd");
		var Acti = 0;
		if($(this).is(':checked')){
			Acti = 1;
		}
		...
		$.ajax({
			url: 'acciones.ajax.php',
			type: 'POST',
			data: 'accion=ACTIVAR_TRD&id_tvd='+IdTRD+'&acti='+Acti,
			beforeSend: function(){
	...
	$(document).on('blur', '#Txtag', function(event){
		...
		$.ajax({
			url: 'acciones.ajax.php',
			type: 'POST',
			data: 'accion=GESTIONAR_RETENCION_AG&id_tvd='+IdTRD+'&agForm='+$(this).val(),
			beforeSend: function(){
				$("#DivAlertaSubseries").html('<div class="alert alert-info"><button class="close" data-dismiss="alert"></button><a href="#" class="link"><img src="../../../../public/assets/img/loading.gif" width="20" height="20"> Info.:</a> Enviando informacóm, por favor espere. </div>');
			},
			success:function(msj){
	...
	$(document).on('blur', '#Txtac', function(event){
		...
		$.ajax({
			url: 'acciones.ajax.php',
			type: 'POST',
			data: 'accion=GESTIONAR_RETENCION_AC&id_tvd='+IdTRD+'&acForm='+$(this).val(),
			beforeSend: function(){
				$("#DivAlertaSubseries").html('<div class="alert alert-info"><button class="close" data-dismiss="alert"></button><a href="#" class="link"><img src="../../../../public/assets/img/loading.gif" width="20" height="20"> Info.:</a> Enviando informacóm, por favor espere. </div>');
			},
			success:function(msj){
	...
	$(document).on('click', '.DispoFinal_ct', function(event){
		...
		$.ajax({
			url: 'acciones.ajax.php',
			type: 'POST',
			data: 'accion=GESTIONAR_DISPO_FINAL_CT&id_tvd='+IdTRD+'&ChkFormCT='+Acti,
			beforeSend: function(){
				$("#DivAlertaSubseries").html('<div class="alert alert-info"><button class="close" data-dismiss="alert"></button><a href="#" class="link"><img src="../../../../public/assets/img/loading.gif" width="20" height="20"> Info.:</a> Enviando informacóm, por favor espere. </div>');
			},
			success:function(msj){
	...
	$(document).on('click', '.DispoFinal_e', function(event){
		...
		$.ajax({
			url: 'acciones.ajax.php',
			type: 'POST',
			data: 'accion=GESTIONAR_DISPO_FINAL_E&id_tvd='+IdTRD+'&ChkFormE='+Acti,
			beforeSend: function(){
				$("#DivAlertaSubseries").html('<div class="alert alert-info"><button class="close" data-dismiss="alert"></button><a href="#" class="link"><img src="../../../../public/assets/img/loading.gif" width="20" height="20"> Info.:</a> Enviando informacóm, por favor espere. </div>');
			},
			success:function(msj){
	...
	$(document).on('click', '.DispoFinal_dm', function(event){
		...
		$.ajax({
			url: 'acciones.ajax.php',
			type: 'POST',
			data: 'accion=GESTIONAR_DISPO_FINAL_DM&id_tvd='+IdTRD+'&ChkFormDM='+Acti,
			beforeSend: function(){
				$("#DivAlertaSubseries").html('<div class="alert alert-info"><button class="close" data-dismiss="alert"></button><a href="#" class="link"><img src="../../../../public/assets/img/loading.gif" width="20" height="20"> Info.:</a> Enviando informacóm, por favor espere. </div>');
			},
			success:function(msj){
	...
	$(document).on('click', '.DispoFinal_s', function(event){
		...
		$.ajax({
			url: 'acciones.ajax.php',
			type: 'POST',
			data: 'accion=GESTIONAR_DISPO_FINAL_S&id_tvd='+IdTRD+'&ChkFormS='+Acti,
			beforeSend: function(){
				$("#DivAlertaSubseries").html('<div class="alert alert-info"><button class="close" data-dismiss="alert"></button><a href="#" class="link"><img src="../../../../public/assets/img/loading.gif" width="20" height="20"> Info.:</a> Enviando informacóm, por favor espere. </div>');
			},
			success:function(msj){
