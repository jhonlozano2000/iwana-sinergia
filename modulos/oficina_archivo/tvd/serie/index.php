                                            ...
                                            <table class="table table-striped" id="example1" >
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width: 70%">Serie</th>
                                                        <th style="width: 10%"></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                    $Serie = SerieTVD::Listar(1 , "", "", "");
                                                    foreach ($Serie as $item):
                                                        ?>
                                                        <tr id="TRD<?php echo $item['id_serie']; ?>">
                                                            <td>
                                                                <div class="checkbox check-success">
                                                                    ...
                                                                    ?>
                                                                    <input id="acti<?php echo $item['id_serie']; ?>" class="acti" type="checkbox" <?php echo $checked; ?> data-id="<?php echo $item['id_serie']; ?>">
                                                                    <label for="acti<?php echo $item['id_serie']; ?>"></label>
                                                                </div>
                                                            </td>
                                                            <td><?php echo $item['cod_serie']; ?></td>
                                                            <td><?php echo $item['nom_serie']; ?></td>
                                                            <td>
                                                                <div class="pull-left">
                                                                    <a href="edit.php?id=<?php echo $item['id_serie']; ?>" class="btn btn-warning btn-circle">
                                                                        <i class="glyphicon glyphicon-pencil"></i>
                                                                    </a>
                                                                    <button type="button" class="btn btn-danger btn-circle" id="BtnEliminar" data-id="<?php echo $item['id_serie']; ?>" data-nom="<?php echo $item['nom_serie']; ?>">
