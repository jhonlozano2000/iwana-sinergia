...
$Serie = SerieTVD::Buscar(1, $_REQUEST['id'], "", "");
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Oficina de Archivo, TVD Series :::...</title>
...
<body class="">
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="#" class="active">Oficina de Archivo, TVD Series.</a>
                    </li>
                </ul>
                ...
                <form role="form" name="FrmDatos" id="FrmDatos">
                    ...
                    <input name="id_serie" id="id_serie" type="hidden" value="<?php echo $Serie -> getId_Serie(); ?>">
                            ...
                            <div class="grid simple">
                                <div class="grid-body no-border">
                                    <div class="row column-seperation">
                                        <div class="col-md-6">
                                            <h4><span class="text-warning">Editar</span>, Información básica de la serie</h4>   
                                            <div class="row form-row">
                                                <div class="col-md-6">
                                                    <input name="cod_serie" type="text" class="form-control" id="cod_serie"
                                                    placeholder="Código de la serie"
                                                    value="<?php echo $Serie -> getCod_Serie(); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-12">
                                                    <input name="nom_serie" type="text" class="form-control" id="nom_serie"
                                                    placeholder="Nombre de la serie"
                                                    value="<?php echo $Serie -> getNom_Serie(); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-12">
                                                    <textarea name="observa" rows="3" class="form-control" id="observa"
                                                    placeholder="Observaciones si las hay..."><?php echo trim($Serie -> getObserva()); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-8">
    ...
    <script src="../../reten_documental/serie/funciones.ajax.js"></script>
