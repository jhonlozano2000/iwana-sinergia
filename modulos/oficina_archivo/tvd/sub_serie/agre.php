                                    ...
                                    <div class="row column-seperation">
                                        <div class="col-md-5">
                                            ...
                                            <div class="row form-row">
                                                <div class="col-md-12">
                                                    <input name="cod_subserie" type="text" class="form-control" id="cod_subserie" placeholder="Código de la subserie">
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-12">
                                                    <input name="nom_subserie" type="text" class="form-control" id="nom_subserie" placeholder="Nombre de la subserie">
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-12">
