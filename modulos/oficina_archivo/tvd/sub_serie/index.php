                                            ...
                                            <table class="table table-striped" id="example1" >
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width: 10%">Cóodigo</th>
                                                        <th style="width: 75%">Subserie</th>
                                                        <th style="width: 15%"></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                    $Subserie = SubSerieTVD::Listar(1, "", "", "", "");
                                                    foreach ($Subserie as $item):
                                                        ?>
                                                        <tr id="TrDatos<?php echo $item['id_subserie']; ?>">
                                                            <td>
                                                                <div class="checkbox check-success">
                                                                    ...
                                                                    ?>
                                                                    <input id="acti<?php echo $item['id_subserie']; ?>" class="acti" type="checkbox" <?php echo $checked; ?> data-id="<?php echo $item['id_subserie']; ?>">
                                                                    <label for="acti<?php echo $item['id_subserie']; ?>"></label>
                                                                </div>
                                                            </td>
                                                            <td><?php echo $item['cod_subserie']; ?></td>
                                                            <td><?php echo $item['nom_subserie']; ?></td>
                                                            <td>
                                                                <div class="pull-left">
                                                                    <a href="edit.php?id=<?php echo $item['id_subserie']; ?>" class="btn btn-warning btn-circle">
                                                                        <i class="glyphicon glyphicon-pencil"></i>
                                                                    </a>
                                                                    <button type="button" class="btn btn-danger btn-circle" name="BtnEliminar" id="BtnEliminar" data-id="<?php echo $item['id_subserie']; ?>" data-nom="<?php echo $item['nom_subserie']; ?>">
