                                ...
                                <div class="row column-seperation">
                                    <div class="col-md-3">
                                        ...
                                        <div class="row form-row">
                                            ...
                                            <div class="col-md-6">
                                                <input name="agForm" type="text" class="form-control" id="agForm" placeholder="A.G" value="0">
                                            </div>
                                            <div class="col-md-6">
                                                <input name="acForm" type="text" class="form-control" id="acForm" placeholder="A.C" value="0">
                                            </div>
                                        </div>
                                        <div class="row form-row">
