...
$SubSerie = SubSerie::Buscar(1, $_REQUEST['id'], "", "", "");
...
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Oficina de Archivo, Subseries :::...</title>
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="#" class="active">Oficina de Archivo, Subseries.</a>
                    </li>
                </ul>
                ...
                <form role="form" name="FrmDatos" id="FrmDatos">
                    ...
                    <input name="id_subserie" id="id_subserie" type="hidden" value="<?php echo $SubSerie -> getId_SubSerie(); ?>">
                                ...
                                <div class="grid-body no-border">
                                    <div class="row column-seperation">
                                        <div class="col-md-5">
                                            <h4>
                                                ...
                                                Información básica de la SubSerie
                                            </h4>      
                                            <div class="row form-row">
                                                <div class="col-md-12">
                                                    <input name="cod_subserie" type="text" class="form-control" id="cod_subserie" placeholder="Código de la subserie" value="<?php echo $SubSerie -> getCod_SubSerie(); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-12">
                                                    <input name="nom_subserie" type="text" class="form-control" id="nom_subserie" placeholder="Nombre de la subserie" value="<?php echo $SubSerie -> getSubSerie(); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-12">
                                            ...
                                            <div class="row form-row">
                                                <div class="col-md-8">
                                                    <div class="checkbox check-success">
                                                        <?php
                                                        if($SubSerie->getActi() == 1){
                                                            $checked = "checked";
                                                        }else{
                                                            $checked = "";
                                                        }
                                                        ?>
                                                        <input id="ChkActi" type="checkbox" <?php echo $checked; ?>>
                                                        <label for="ChkActi">Activo</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <h4><span class="text-success">Tipos documentales, </span>Asociados a la subserie</h4>
                                            <div class="row form-row" style="overflow-y: auto; height:300px;">
                                                <div class="col-md-12">
                                                    <table class="table table-bordered no-more-tables" id="TiposDocumentales">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $Documentos = SubSerie::Listar(6, $_REQUEST['id'], "", "", "", "");
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <div class="pull-right">
                                           <button class="btn btn-success btn-cons" type="button" id="BtnBuscarTipoDocumental" name="BtnBuscarTipoDocumental" data-toggle="modal" data-target="#myModalTipoDocumental"><i class="fa fa-search"></i> Buscar Tipo Documental</button>
                                       </div>
                                   </div>
                               </div>
                           </div>
