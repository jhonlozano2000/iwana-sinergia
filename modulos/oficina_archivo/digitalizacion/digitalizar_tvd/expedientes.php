...
if($ConfiguracionOtras->get_Incluir_TRD() == 0){
    ...
    $Documentos = TipoDocumentoTVD::Listar(1, "", "");
...
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Oficina de Archivo, Digitalización con TVD :::...</title>
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="#" class="active">Oficina de Archivo - Digitalización con TVD.</a>
                    </li>
                </ul>
                                    ...
                                    <div class="row column-seperation">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="row form-row">
                                                ...
                                                <div class="col-md-3">
                                                    <select name="id_tomo" id="id_tomo" class="select2 form-control  input-sm">
                                                    </select>
                                                </div>

                                                <div class="col-m3">
                                                    <button type="button" class="btn btn-success btn-cons input-sm" id="BtnNuevoTomo" disabled>
                                        ...
                                        <div class="row column-seperation">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="row form-row">
                                                        <div class="col-md-2">
                                                            <select name="id_tomo_ver_tipo_documento" id="id_tomo_ver_tipo_documento" class="select2 form-control  input-sm">
                                                                <?php echo $Combo_Tomos; ?>
                                                            </select>
                                                        </div>
                                                        <div class="col-md-10">
                                                            <input name="busca_ver_archivo" type="text" class="form-control input-sm" id="busca_ver_archivo" placeholder="Buscar archivo">
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="tabComoUnTodoVerExpediente">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row form-row">
                                                    <div class="col-md-2">
                                                        <select name="id_tomo_ver_archivos_ComoUnTodo" id="id_tomo_ver_archivos_ComoUnTodo" class="select2 form-control  input-sm">
                                                            <?php echo $Combo_Tomos; ?>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-10">
