...
$Expediente = Digitalizacion::Listar(1, 0, 0, 0, 0, $_POST['criterio'], $_POST['criterio'], $_POST['criterio'], $_POST['criterio'], $_POST['criterio']);
?>
<table class="table table-hover table-condensed" id="Tbl2">
    <thead>
        <tr>
            <th style="width:1%"></th>
            <th style="width:1%">Dependencia</th>
            <?php
            if($IncluirOficna == 2){
                ?>
                <th style="width:1%">Oficina</th>
                <?php
            }
            ?>
            <th style="width:1%">Serie</th>
            <th style="width:1%">SubSerie</th>
            <th style="width:2%">Codígo</th>
            <th style="width:40%">Titulo</th>
            <th style="width:30%">Detalle 1</th>
            <th style="width:20%">Detalle 2</th>
        </tr>
    </thead>
    <tbody>
        <?php
