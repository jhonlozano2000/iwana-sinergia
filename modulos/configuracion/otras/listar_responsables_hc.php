    ...
    <tbody>
        ...
        foreach($Responsables as $Item):
            ...
            <tr>
                ...
                <td>
                    <button class="borrar btn btn-danger btn-xs btn-mini" data-id_funcio_deta="<?php echo $Item['id_funcio_deta']; ?>" id="BtnEliminarResponsable"><i class="fa fa-trash-o"></i></button>
                </td>
            </tr>
            <?php
        endforeach;
