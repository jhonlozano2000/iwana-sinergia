...
$Ruta = ServidorGestion::Buscar(2, $_REQUEST['id'], "", "");

$Dependencia = Dependencia::Listar(1, "", "", "", "");
$Combo_Dependencias = "";
foreach($Dependencia as $Item):
    if($Item['id_depen'] == $Ruta->get_IdDepen()){
...
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Configuración, Rutas Archivo de Gestión :::...</title>
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="#" class="active">Configuración, Rutas Archivo de Gestión.</a>
                    </li>
                </ul>
                            ...
                            <div class="grid simple">
                                <div class="grid-body no-border">
                                    <div class="row column-seperation">
                                        <div class="col-md-6">
                                            <h4><span class="text-warning">Editar</span>, Información básica de la para el archivo de gestión</h4>   
