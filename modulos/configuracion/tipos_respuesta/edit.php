...
$tipoRespues = TipoRespuesta::Buscar(1, $_REQUEST['id'], "", "");
?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Configuración, Tipos de respuesta :::...</title>
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Configuración - Tipos de respuesta.</a> </li>
                </ul>
                    ...
                    <div class="grid simple">
                        <div class="grid-body no-border">
                            <form class="form-no-horizontal-spacing" id="form-condensed">
                                ...
                                <input name="id_respue" type="hidden" id="id_respue" value="<?php echo $tipoRespues->get_Id(); ?>">
                                <input name="accion" id="accion" type="hidden" value="EDITAR">

                                <div class="row column-seperation">
                                    <div class="col-md-6">
                                        <h4><span class="text-success">Editar, </span>Información básica del tipo de respuesta</h4>
                                        <div class="row form-row">
                                            <div class="col-md-6">
                                                <input name="nom_respues" type="text" class="form-control" id="nom_respues" placeholder="Tipo de respuesta" value="<?php echo $tipoRespues->get_Nombre(); ?>">
                                            </div>
                                        </div>
                                        <div class="row form-row">
                                            <div class="col-md-8">
