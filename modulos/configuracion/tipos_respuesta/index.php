...
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Configuración, Tipos de respuestas :::...</title>
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Configuración, Tipos de respuestas</a> </li>
                </ul>
                                    ...
                                    <div class="row column-seperation">
                                        ...
                                        <div class="col-md-12">
                                            <table class="table table-striped" id="example1">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $tipoRespues = TipoRespuesta::Listar(1, "", "", "");
                                                    foreach ($tipoRespues as $item) :
                                                    ?>
                                                        <tr id="TrDatos<?php echo $item['id_respue']; ?>">
                                                            <td>
                                                                <div class="checkbox check-success">
                                                                    ...
                                                                    ?>
                                                                    <input id="acti<?php echo $item['id_respue']; ?>" class="acti" type="checkbox" <?php echo $checked; ?> data-id="<?php echo $item['id_respue']; ?>" data-nom="<?php echo $item['nom_respues']; ?>">
                                                                    <label for="acti<?php echo $item['id_respue']; ?>"></label>
                                                                </div>
                                                            </td>
                                                            <td><?php echo $item['nom_respues']; ?></td>
                                                            <td>
                                                                <a href="edit.php?id=<?php echo $item['id_respue']; ?>" class="btn btn-warning btn-circle">
                                                                    <i class="glyphicon glyphicon-pencil"></i>
                                                                </a>
                                                                <button type="button" class="btn btn-danger btn-circle" id="BtnEliminar" data-id="<?php echo $item['id_respue']; ?>" data-nom="<?php echo $item['nom_respues']; ?>">
