...
require_once "../../clases/configuracion/class.ConfigOrigenCorrespondencia.php";

$TipoCorrespondencia = TipoCorrespondencia::Buscar(2, $_REQUEST['id'], "", "");

$OrigenCorrespondencia = OrigenCorrespondencia::Listar(1, "", "");
$Combo_OrigenCorrespondencia = "";
foreach($OrigenCorrespondencia as $Item):
    if($Item['id_origen'] == $TipoCorrespondencia->get_IdOrigen()){
        $Combo_OrigenCorrespondencia.= "<option value='".$Item['id_origen']."' selected>".$Item['nom_origen']."</option>";
    }else{
        $Combo_OrigenCorrespondencia.= "<option value='".$Item['id_origen']."'>".$Item['nom_origen']."</option>";
    }
endforeach;
?>
<!DOCTYPE html>
...
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Configuración, Tipo de Correspondencia :::...</title>
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Configuración - Tipo de Correspondencia.</a> </li>
                </ul>
                    ...
                    <div class="grid simple">
                        <div class="grid-body no-border">
                            <form class="form-no-horizontal-spacing" id="form-condensed">
                                ...
                                <input name="id_tipo" type="hidden" id="id_tipo" value="<?php echo $TipoCorrespondencia->get_Id(); ?>">
                                <input name="accion" id="accion" type="hidden" value="EDITAR">

                                <div class="row column-seperation">
                                    <div class="col-md-6">
                                        <h4><span class="text-success">Editar, </span>Información básica de la Tipo de Correspondencia</h4>
                                        <div class="row form-row">
                                            <div class="col-md-6">
                                                <select name="id_origen" id="id_origen" class="select2 form-control">
                                                    <option value="0">...::: Elije el Origen :::...</option>
                                                    <?php echo $Combo_OrigenCorrespondencia; ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row form-row">
                                            <div class="col-md-6">
                                                <input name="nom_tipo" type="text" class="form-control" id="nom_tipo" placeholder="Tipo de Correspondencia" value="<?php echo $TipoCorrespondencia->get_NombreTipo(); ?>">
                                            </div>
                                        </div>
                                        <div class="row form-row">
                                            <div class="col-md-8">
                                                <div class="checkbox check-success">
                                                    <?php
                                                    if($TipoCorrespondencia->get_Acti() == 1){
                                                        $checked = "checked";
                                                    }else{
                                                        $checked = "";
                                                    }
