$(document).ready(function () {
    ...
    $("#BtnGuardar").click(function () {
        if ($("#nom_tipo").val() == "") {
            $("#DivAlerta").load("../../../config/mensajes.php", { alerta: 3, mensaje: "Te hizo falta el Tipo de Correspondencia" }, function () {});
            $("#nom_tipo").focus();
        } else {
            ...
            $.ajax({
                ...
                data: "accion=Insertar&nom_tipo=" + $("#nom_tipo").val() + "&id_origen=" + $("#id_origen").val() + "&acti=" + acti,
                beforeSend: function () {
        ...
        if (confirm("Desea editar el registro: " + $("#nom_tipo").val())) {
            if ($("#nom_tipo").val() == "") {
                ...
                $.ajax({
                    url: "acciones.ajax.php",
                    type: "POST",
                    data: "accion=Editar&id_tipo=" + $("#id_tipo").val() + "&nom_tipo=" + $("#nom_tipo").val() + "&id_origen=" + $("#id_origen").val() + "&acti=" + acti,
                    beforeSend: function () {
                        $("#DivAlerta").load("../../../config/mensajes.php", { alerta: 5, mensaje: "Enviando información...", Imagen: "../../../public/assets/img/loading.gif" }, function () {});
                    },
                    success: function (msj) {
        ...
        swal(
            ...
            function () {
                $.ajax({
                    url: "acciones.ajax.php",
                    type: "POST",
                    data: "accion=ACTIVAR_INACTIVAR&id_tipo=" + Id + "&acti=" + Acti,
                    beforeSend: function () {
