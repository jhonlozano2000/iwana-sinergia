...
<head>
    ...
    <link href="../../../public/assets/css/botones_redondos.css" rel="stylesheet" type="text/css" media="screen" />
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
...
<body class="">
                                    ...
                                    <div class="row column-seperation">
                                        ...
                                        <div class="col-md-12">
                                            <table class="table table-striped" id="example1">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $TipoCorrespondencia = TipoCorrespondencia::Listar(1, "", "", "");
                                                    foreach ($TipoCorrespondencia as $item) :
                                                    ?>
                                                        <tr id="TrDatos<?php echo $item['id_tipo']; ?>">
                                                            <td>
                                                                <div class="checkbox check-success">
                                                                    ...
                                                                    ?>
                                                                    <input id="acti<?php echo $item['id_tipo']; ?>" class="acti" type="checkbox" <?php echo $checked; ?> data-id="<?php echo $item['id_tipo']; ?>" data-nom="<?php echo $item['nom_tipo']; ?>">
                                                                    <label for="acti<?php echo $item['id_tipo']; ?>"></label>
                                                                </div>
                                                            </td>
                                                            <td><?php echo $item['nom_origen']; ?></td>
                                                            <td><?php echo $item['nom_tipo']; ?></td>
                                                            <td>
                                                                <a href="edit.php?id=<?php echo $item['id_tipo']; ?>" class="btn btn-warning btn-circle">
                                                                    <i class="glyphicon glyphicon-pencil"></i>
                                                                </a>
                                                                <button type="button" class="btn btn-danger btn-circle" id="BtnEliminar" data-id="<?php echo $item['id_tipo']; ?>" data-nom="<?php echo $item['nom_tipo']; ?>">
    ...
    <link href="../../../public/assets/sweetalert2/sweetalert.css" rel="stylesheet" type="text/css">s">
