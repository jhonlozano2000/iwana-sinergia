...
$Ruta = ServidorCalidad::Buscar(2, $_REQUEST['id'], "", "");
?>
<!DOCTYPE html>
<html>
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="#" class="active">Configuración, Rutas Calidad.</a>
                    </li>
                </ul>
                            ...
                            <div class="grid simple">
                                <div class="grid-body no-border">
                                    <div class="row column-seperation">
                                        <div class="col-md-6">
                                            <h4><span class="text-warning">Editar</span>, Información básica de la ruta para los archivos de calidad</h4>
