...
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Configuración, Rutas calidad :::...</title>
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="#" class="active">Configuración, Rutas para los archivos de calidad.</a>
                    </li>
                </ul>
                                    ...
                                    <div class="row column-seperation">
                                        <div class="col-md-6">
                                            <h4>
                                                ...
                                                </span>Información básica de la ruta
                                            </h4>

                                            <div class="row form-row">
                                                <div class="col-md-12">
                                                    <input name="ruta" type="text" class="form-control" id="ruta" placeholder="Ruta">
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-6">
                                            ...
                                            <div class="row form-row">
                                                <div class="col-md-12">
                                                    <textarea name="observa" id="observa" class="form-control" placeholder="Ingrese las observaciones si las hay..." cols="" rows=""></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-8">
