...
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Configuración, Despedida :::...</title>
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Configuración, Despedida</a> </li>
                </ul>
                                            ...
                                            <table class="table table-striped" id="example1" >
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach($despedida as $item):
                                                        ?>
                                                        <tr id="TrDatos<?php echo $item['id_despedida']; ?>">
                                                            <td>
                                                                <div class="checkbox check-success">
                                                                    ...
                                                                    ?>
                                                                    <input id="acti<?php echo $item['id_despedida']; ?>" class="acti" type="checkbox" <?php echo $checked; ?> data-id="<?php echo $item['id_despedida']; ?>" data-nom="<?php echo $item['despedida']; ?>">
                                                                    <label for="acti<?php echo $item['id_despedida']; ?>"></label>
                                                                </div>
                                                            </td>
                                                            <td><?php echo $item['despedida']; ?></td>
                                                            <td>
                                                                <a href="edit.php?id=<?php echo $item['id_despedida']; ?>" class="btn btn-warning btn-circle">
                                                                    <i class="glyphicon glyphicon-pencil"></i>
                                                                </a>
                                                                <button type="button" class="btn btn-danger btn-circle" id="BtnEliminar" data-id="<?php echo $item['id_despedida']; ?>" data-nom="<?php echo $item['despedida']; ?>">
