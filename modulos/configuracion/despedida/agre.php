        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="#" class="active">Configuración - Despedida.</a>
                    </li>
                </ul>
                            ...
                            <div class="grid simple">
                                ...
                                <div class="grid-body no-border">
                                    <div class="row column-seperation">
                                        <div class="col-md-6">
                                            <h4><span class="text-success">Nueva, </span>Información básica de la Despedida</h4>
                                            <div class="row form-row">
                                                <div class="col-md-6">
                                                    <input name="despedida" type="text" class="form-control" id="despedida" placeholder="Despedida">
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-8">
