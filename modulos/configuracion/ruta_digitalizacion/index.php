...
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Configuración, Ruta Digitalización :::...</title>
                                    ...
                                    <div class="row column-seperation">
                                        <div class="col-md-12">
                                            ...
                                            <table class="table table-striped" id="example1" >
                                                ...
                                                <tbody>
                                                    <?php
                                                    $Ruta = ServidorDigitalizacion::Listar(1, 0, 0, "");
                                                        ...
                                                        <tr id="TrDatos<?php echo $item['id_ruta']; ?>">
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    ...
                                                                    <button type="button" class="btn btn-danger btn-circle" id="BtnEliminar" data-id="<?php echo $item['id_ruta']; ?>" data-nom="<?php echo $item['servidor']." - ".$item['ruta']; ?>">
