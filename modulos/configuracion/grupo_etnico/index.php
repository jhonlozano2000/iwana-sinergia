                                    ...
                                    <div class="row column-seperation">
                                        ...
                                        <div class="col-md-12">
                                            <table class="table table-striped" id="example1" >
                                                ...
                                                <tbody>
                                                    <?php
                                                    $GrupoEtnico = GrupoEtnico::Listar(1, "", "");
                                                    foreach($GrupoEtnico as $item):
                                                        ?>
                                                        <tr id="TrDatos<?php echo $item['id_grupo_etnico']; ?>">
                                                            <td>
                                                                <div class="checkbox check-success">
                                                                    ...
                                                                    ?>
                                                                    <input id="acti<?php echo $item['id_grupo_etnico']; ?>" class="acti" type="checkbox" <?php echo $checked; ?> data-id="<?php echo $item['id_grupo_etnico']; ?>" data-nom="<?php echo $item['nom_grupo_etnico']; ?>">
                                                                    <label for="acti<?php echo $item['id_grupo_etnico']; ?>"></label>
                                                                </div>
                                                            </td>
                                                            <td><?php echo $item['nom_grupo_etnico']; ?></td>
                                                            <td>
                                                                <a href="edit.php?id=<?php echo $item['id_grupo_etnico']; ?>" class="btn btn-warning btn-circle">
                                                                    <i class="glyphicon glyphicon-pencil"></i>
                                                                </a>
                                                                <button type="button" class="btn btn-danger btn-circle" id="BtnEliminar" data-id="<?php echo $item['id_grupo_etnico']; ?>" data-nom="<?php echo $item['nom_grupo_etnico']; ?>">
