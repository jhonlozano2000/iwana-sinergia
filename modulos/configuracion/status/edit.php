...
$Status = Status::Buscar(2, $_REQUEST['id'], "");
?>
<!DOCTYPE html>
<html>
<head>
                    ...
                    <div class="grid simple">
                        <div class="grid-body no-border">
                            <form class="form-no-horizontal-spacing" id="form-condensed">
                                ...
                                <input name="id_status" type="hidden" id="id_status" value="<?php echo $Status->get_Id(); ?>">
                                <input name="accion" id="accion" type="hidden" value="EDITAR">

                                <div class="row column-seperation">
                                    <div class="col-md-6">
                                        <h4><span class="text-success">Editar, </span>Información básica del Status</h4>
                                         <div class="row form-row">
                                    <div class="col-md-6">
                                        <input name="status" type="text" class="form-control" id="status" placeholder="Status" value="<?php echo $Status->get_Nombre(); ?>">
                                    </div>
                                </div>
                                <div class="row form-row">
                                    <div class="col-md-8">
