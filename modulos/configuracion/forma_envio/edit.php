...
$FormaEnvio = FormaEnvio::Buscar(1, $_REQUEST['id']);
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Configuración - Formas de Envio.</a> </li>
                </ul>
                    ...
                    <div class="grid simple">
                        <div class="grid-body no-border">
                            <form class="form-no-horizontal-spacing" id="form-condensed">
                                ...
                                <input name="id_formaenvio" type="hidden" id="id_formaenvio" value="<?php echo $FormaEnvio->get_IdForma(); ?>">
                                <input name="accion" id="accion" type="hidden" value="EDITAR">

                                <div class="row column-seperation">
                                    <div class="col-md-6">
                                        <h4><span class="text-success">Editar, </span>Información básica de la Forma de Envío</h4>
                                         <div class="row form-row">
                                    <div class="col-md-6">
                                        <input name="nom_formaenvi" type="text" class="form-control" id="nom_formaenvi"
                                        placeholder="Forma de envio" value="<?php echo $FormaEnvio->get_NomForma(); ?>">
                                    </div>
                                </div>
                                <div class="row form-row">
                                    <div class="col-md-6">
                                        <textarea name="observa" id="observa" class="form-control" placeholder="Ingrese las observaciones si las hay..." cols="" rows=""><?php echo $FormaEnvio->get_Observa(); ?></textarea>
                                    </div>
                                </div>
                                <div class="row form-row">
                                    <div class="col-md-8">
