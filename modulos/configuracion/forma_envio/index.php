...
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Configuración, Formas de Envío :::...</title>
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Configuración, Formas de Envío</a> </li>
                </ul>
                                    ...
                                    <div class="row column-seperation">
                                        ...
                                        <div class="col-md-12">
                                            <table class="table table-striped" id="example1" >
                                                ...
                                                <tbody>
                                                    <?php
                                                    $FormaEnvio = FormaEnvio::Listar(1, 0);
                                                    foreach ($FormaEnvio as $item):
                                                        ?>
                                                        <tr id="TrDatos<?php echo $item['id_formaenvio']; ?>">
                                                            <td>
                                                                <div class="checkbox check-success">
                                                                    ...
                                                                    ?>
                                                                    <input id="acti<?php echo $item['id_formaenvio']; ?>" class="acti" type="checkbox" <?php echo $checked; ?> data-id="<?php echo $item['id_formaenvio']; ?>" data-nom="<?php echo $item['nom_formaenvi']; ?>">
                                                                    <label for="acti<?php echo $item['id_formaenvio']; ?>"></label>
                                                                </div>
                                                            </td>
                                                            <td><?php echo $item['nom_formaenvi']; ?></td>
                                                            <td><?php echo $item['observa']; ?></td>
                                                            <td>
                                                                <a href="edit.php?id=<?php echo $item['id_formaenvio']; ?>" class="btn btn-warning btn-circle">
                                                                    <i class="glyphicon glyphicon-pencil"></i>
                                                                </a>
                                                                <button type="button" class="btn btn-danger btn-circle" id="BtnEliminar" data-id="<?php echo $item['id_formaenvio']; ?>" data-nom="<?php echo $item['nom_formaenvi']; ?>">
