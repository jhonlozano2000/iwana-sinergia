...
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Configuración, Ruta Temp :::...</title>
                                    ...
                                    <div class="row column-seperation">
                                        <div class="col-md-12">
                                            ...
                                            <table class="table table-striped" id="example1" >
                                                ...
                                                <tbody>
                                                    <?php
                                                    $Ruta = ServidorTemp::Listar(1, 0, 0, "");
                                                    foreach ($Ruta as $item):
                                                        ...
                                                        <tr id="TrDatos<?php echo $item['id_ruta']; ?>">
                                                            ...
                                                            <td><?php echo $item['contra']; ?></td>
                                                            <td>
                                                                <?php 
                                                                if($item['tipo_correspon'] == 1){
                                                                    echo "Correspondencia recibida";
                                                                }elseif($item['tipo_correspon'] == 2){
                                                                    echo "Correspondencia enviada";
                                                                }elseif($item['tipo_correspon'] == 3){
                                                                    echo "Correspondencia interna";
                                                                }elseif($item['tipo_correspon'] == 4){
                                                                    echo "Plantillas internas";
                                                                }
                                                                ?>
                                                            </td>
