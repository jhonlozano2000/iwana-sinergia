...
$Ruta = ServidorTemp::Buscar(2, $_REQUEST['id'], "", "");
?>
<!DOCTYPE html>
<html>
<head>
                            ...
                            <div class="grid simple">
                                <div class="grid-body no-border">
                                    <div class="row column-seperation">
                                        <div class="col-md-6">
                                            <h4><span class="text-warning">Editar</span>, Información básica de la ruta temporal</h4>
                                            <div class="row form-row">
                                                <div class="col-md-6">
                                                    <select name="tipo_correspon" id="tipo_correspon" class="select2 form-control">
                                                        <option value="1">Correspondencia recibida</option>
                                                        <option value="2">Correspondencia enviada</option>
                                                        <option value="3">Correspondencia interna</option>
                                                        <option value="4">Plantillas</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-6">
                                                    <input name="ip" type="text" class="form-control" id="ip" placeholder="Servidor" value="<?php echo $Ruta->get_Ip(); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-12">
