...
$tipoDocumento = TipoDocumento::Buscar(1, $_REQUEST['id'], "", "");
?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Configuración, Tipos de documentos :::...</title>
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Configuración - Tipos de documentos.</a> </li>
                </ul>
                    ...
                    <div class="grid simple">
                        <div class="grid-body no-border">
                            <form class="form-no-horizontal-spacing" id="form-condensed">
                                ...
                                <input name="id_tipo" type="hidden" id="id_tipo" value="<?php echo $tipoDocumento->get_Id(); ?>">
                                <input name="accion" id="accion" type="hidden" value="EDITAR">

                                <div class="row column-seperation">
                                    <div class="col-md-6">
                                        <h4><span class="text-success">Editar, </span>Información básica del tipo de documentos</h4>
                                        <div class="row form-row">
                                            <div class="col-md-6">
                                                <input name="cod_tipo" type="text" class="form-control" id="cod_tipo" placeholder="Código del tipo de documento" value="<?php echo $tipoDocumento->get_CodTipo(); ?>">
                                            </div>
                                        </div>
                                        <div class="row form-row">
                                            <div class="col-md-6">
                                                <input name="nom_tipo" type="text" class="form-control" id="nom_tipo" placeholder="Tipo de documentos" value="<?php echo $tipoDocumento->get_NomTipo(); ?>">
                                            </div>
                                        </div>
                                        <div class="row form-row">
                                            <div class="col-md-8">
