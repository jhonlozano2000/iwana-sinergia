...
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Configuración, Régimen :::...</title>
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Configuración, Régimen</a> </li>
                </ul>
                                    ...
                                    <div class="row column-seperation">
                                        ...
                                        <div class="col-md-12">
                                            <table class="table table-striped" id="example1" >
                                                ...
                                                <tbody>
                                                    <?php
                                                    $Regimen = Regimen::Listar(1, "", "");
                                                    foreach($Regimen as $item):
                                                        ?>
                                                        <tr id="TrDatos<?php echo $item['id_regime']; ?>">
                                                            <td>
                                                                <div class="checkbox check-success">
                                                                    ...
                                                                    ?>
                                                                    <input id="acti<?php echo $item['id_regime']; ?>" class="acti" type="checkbox" <?php echo $checked; ?> data-id="<?php echo $item['id_regime']; ?>" data-nom="<?php echo $item['nom_regimen']; ?>">
                                                                    <label for="acti<?php echo $item['id_regime']; ?>"></label>
                                                                </div>
                                                            </td>
                                                            <td><?php echo $item['nom_regimen']; ?></td>
                                                            <td>
                                                                <a href="edit.php?id=<?php echo $item['id_regime']; ?>" class="btn btn-warning btn-circle">
                                                                    <i class="glyphicon glyphicon-pencil"></i>
                                                                </a>
                                                                <button type="button" class="btn btn-danger btn-circle" id="BtnEliminar" data-id="<?php echo $item['id_regime']; ?>" data-nom="<?php echo $item['nom_regimen']; ?>">
