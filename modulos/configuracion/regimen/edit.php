...
require_once '../../clases/configuracion/class.Confignom_regimen.php';

$Regimen = Regimen::Buscar(2, $_REQUEST['id'], "");
?>
<!DOCTYPE html>
<html>
<head>
                    ...
                    <div class="grid simple">
                        <div class="grid-body no-border">
                            <form class="form-no-horizontal-spacing" id="form-condensed">
                                ...
                                <input name="id_regimen" type="hidden" id="id_regimen" value="<?php echo $Regimen->get_Id(); ?>">
                                <input name="accion" id="accion" type="hidden" value="EDITAR">

                                <div class="row column-seperation">
                                    <div class="col-md-6">
                                        <h4><span class="text-success">Editar, </span>Información básica del Régimen</h4>
                                         <div class="row form-row">
                                    <div class="col-md-6">
                                        <input name="nom_regimen" type="text" class="form-control" id="nom_regimen" placeholder="Régimen" value="<?php echo $Regimen->get_Nombre(); ?>">
                                    </div>
                                </div>
                                <div class="row form-row">
                                    <div class="col-md-8">
