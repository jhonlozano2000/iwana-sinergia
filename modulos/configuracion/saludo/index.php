...
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Configuración, Saludo :::...</title>
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Configuración, Saludo</a> </li>
                </ul>
                                            ...
                                            <table class="table table-striped" id="example1" >
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach($Saludo as $item):
                                                        ?>
                                                        <tr id="TrDatos<?php echo $item['id_saludo']; ?>">
                                                            <td>
                                                                <div class="checkbox check-success">
                                                                    ...
                                                                    ?>
                                                                    <input id="acti<?php echo $item['id_saludo']; ?>" class="acti" type="checkbox" <?php echo $checked; ?> data-id="<?php echo $item['id_saludo']; ?>" data-nom="<?php echo $item['saludo']; ?>">
                                                                    <label for="acti<?php echo $item['id_saludo']; ?>"></label>
                                                                </div>
                                                            </td>
                                                            <td><?php echo $item['saludo']; ?></td>
                                                            <td>
                                                                <a href="edit.php?id=<?php echo $item['id_saludo']; ?>" class="btn btn-warning btn-circle">
                                                                    <i class="glyphicon glyphicon-pencil"></i>
                                                                </a>
                                                                <button type="button" class="btn btn-danger btn-circle" id="BtnEliminar" data-id="<?php echo $item['id_saludo']; ?>" data-nom="<?php echo $item['saludo']; ?>">
