        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="#" class="active">Configuración - Saludo.</a>
                    </li>
                </ul>
                            ...
                            <div class="grid simple">
                                ...
                                <div class="grid-body no-border">
                                    <div class="row column-seperation">
                                        <div class="col-md-6">
                                            <h4><span class="text-success">Nueva, </span>Información básica del Saludo</h4>
                                            <div class="row form-row">
                                                <div class="col-md-6">
                                                    <input name="saludo" type="text" class="form-control" id="saludo" placeholder="Saludo">
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-8">
