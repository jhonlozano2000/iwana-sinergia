$(document).ready(function () {
    ...
    $("#BtnGuardar").click(function () {
        if ($("#saludo").val() == "") {
            $("#DivAlerta").load("../../../config/mensajes.php", { alerta: 3, mensaje: "Te hizo falta del saludo" }, function () {});
            $("#saludo").focus();
        } else {
            ...
            $.ajax({
                ...
                data: "accion=Insertar&saludo=" + $("#saludo").val() + "&acti=" + acti,
                beforeSend: function () {
    ...
    $("#BtnEditar").click(function () {
        if (confirm("Desea editar el registro: " + $("#saludo").val())) {
            if ($("#saludo").val() == "") {
                ...
                $.ajax({
                    ...
                    //Form data
                    //datos del formulario
                    data: "accion=Editar&id_saludo=" + $("#id_saludo").val() + "&saludo=" + $("#saludo").val() + "&acti=" + acti,
                    beforeSend: function () {
                        $("#DivAlerta").load("../../../config/mensajes.php", { alerta: 5, mensaje: "Enviando información...", Imagen: "../../../public/assets/img/loading.gif" }, function () {});
                    },
                    success: function (msj) {
        ...
        swal(
            ...
            function () {
                $.ajax({
                    url: "acciones.ajax.php",
                    type: "POST",
                    data: "accion=Eliminar&id_saludo=" + Id,
                    success: function (msj) {
                        if (msj == 1) {
                            $("#TrDatos" + Id).remove();
        ...
        swal(
            ...
            function () {
                $.ajax({
                    url: "acciones.ajax.php",
                    type: "POST",
                    data: "accion=ACTIVAR_INACTIVAR&id_saludo=" + Id + "&acti=" + Acti,
                    beforeSend: function () {
