            ...
            <div class="inner-menu nav-collapse">
                <div id="inner-menu">
                    <div class="inner-wrapper" >
                        <a href="../radicar/index.php" class="btn btn-block btn-primary" >
                    ...
                    <ul class="big-items">
                        <li class="">
                            <a href="../../recibidas/pendientes/index.php">
        ...
        <div class="page-content">
            ...
            <div class="content">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Bandeja, Correspondencia internas, enviadas</a> </li>
                </ul>
                ...
                <div class="page-title" style="display:none">
                    ...
                    <h3>Regresar- <span class="semi-bold">Correspondencia interna</span></h3>
                </div>
