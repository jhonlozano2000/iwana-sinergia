...
?>
        ...
        $numrows     = RadicadoInterno::TotalRegistros_Correspondencia($Accion, "", $_SESSION['SesionFuncioDetaId'], $_SESSION['SesionFuncioDepenId'], $_SESSION['SesionFuncioOfiId'], "", "", $_REQUEST['criterio'], "Enviados");
        $total_pages = ceil($numrows / $per_page);
        $reload      = 'index.php';

        //echo "Accion: " . $Accion . "<br>Total: " . $numrows . "<br>Respon Princi: " . $_SESSION['SesionFuncioResponPrinci'] . " , Jefe Depen: " . $_SESSION['SesionFuncioJefeDependencia'] . ", Funcio deta: " . $_SESSION['SesionFuncioDetaId'] . " , Total: " . $numrows;
        ?>
        ...
        <div id="email-list">
            <table class="table table-hover" id="emails">
                ...
                <tbody id="TblRadicados">
                    <?php
                    if ($numrows > 0) {
                        $query_services = RadicadoInterno::Listar_Correspondencia($Accion, "", $_SESSION['SesionFuncioDetaId'], $_SESSION['SesionFuncioDepenId'], $_SESSION['SesionFuncioOfiId'], $offset, $per_page, $_REQUEST['criterio'], "Enviados");
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <dl class="row">
                                                ...
                                                <dt class="col-sm-4">Radica. Respues:</dt>
                                                <dd class="col-sm-7 "><strong></string><?php echo $item['radica_respuesta']; ?></strong></dd>
                                                <br>
                                                <br>
