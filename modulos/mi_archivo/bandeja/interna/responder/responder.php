...
$IdRadicadoInterno = $_GET['id_radica'];
$Radicado = RadicadoInterno::Listar_Varios(1, $IdRadicadoInterno, "", "", "", "", "", "");
$AsuntoRadicado = "";
foreach ($Radicado as $ItemRadicado) {
    $AsuntoRadicado = $ItemRadicado['asunto'];
}

$IdResponsable = RadicadoInternoResponsable::Buscar(2, $IdRadicadoInterno, "");

$Funcionario = Funcionario::Listar(6, 0, "", "", "", 0, 0, 0);
$Combo_Funcionarios = "";
foreach ($Funcionario as $Item) :
    if ($IdResponsable->get_IdFuncio() === $Item['id_funcio_deta']) {
        $Combo_Funcionarios .= "<option value='" . $Item['id_funcio_deta'] . "' selected
        >" . $Item['nom_oficina'] . " - " . $Item['nom_funcio'] . " " . $Item['ape_funcio'] . "</option>";
    } else {
                    ...
                    <form role="form" name="FrmDatos" id="FrmDatos">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <input name="id_radica_respuesta" type="hidden" id="id_radica_respuesta" value="<?php echo $_GET['id_radica']; ?>">
                                        ...
                                        <div class="grid simple">
                                            ...
                                            <div class="grid-body no-border">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        <div class="controls">
                                                            <input type="text" class="form-control " placeholder="Ingrese aqui el asunto" id="asunto" value="<?php echo "En respuesta del radicado: " . $_GET['id_radica'] . ", con el asunto: " . $AsuntoRadicado ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        <textarea id="postBody" name="postBody" placeholder="Ingrese aqui el texto del mensaje..." class="form-control" style="min-height: 300px;">
                                                            </textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="grid simple">
                                                <div class="grid-title no-border">
                                                    <h4>
                                                        ...
                                                        <span class="semi-bold text-info">Respuesta</span>
                                                    </h4>
                                                </div>
                                        ...
                                        <div class="grid simple">
                                            <div class="grid-title no-border">
                                                <h4>
                                                    ...
                                                    <span class="semi-bold text-info">Adjunto</span>
                                                </h4>
                                            </div>
                                            ...
                                            <div class="grid-body no-border">
                                                ...
                                                <div class="row-fluid">
                                                    <div class="row">
                                                        <div id="dropzone" class="dropzone" style="min-height: 300px;"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="grid simple">
                                <div class="grid-title no-border">
                                    ...
                                    ?>
                                        <button type="button" class="btn btn-success btn-sm btn-small" id="BtnDescargarArchivoInterno" data-id_radicado="<?php echo $Item['id_radica']; ?>" data-id_ruta="<?php echo $Item['id_ruta']; ?>" data-archivo="<?php echo $Item['nom_archivo']; ?>" data-id_funcio="<?php echo $_SESSION['SesionFuncioDetaId']; ?>">
                                            <i class="fa fa-cloud-download"></i> <?php echo $Item['nom_archivo']; ?></button>
                                    <?php
                                    }
                                    ?>
                                </div>
