...
if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
    ...
    require_once '../../../../clases/radicar/class.RadicaRecibidoListarPendienteTramitar.php';
    ...
    <div class="row-fluid dataTables_wrapper">
        ...
        if($action == 'ajax'){
            ...
            $Registro = new RadicadoRecibidoListarPendienteTramitar();
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <dl class="row">
                                                ...
                                                if($item['autoriza'] == 0){
                                                    ?>
                                                    <span class="text-info" id="btnAutorizar" data-id="<?php echo $item['id_radica']; ?>">
                                                        <strong>
                                                            <i class="fa fa-lock text-danger" id="BtnCandado<?php echo $item['id_radica']; ?>"></i>
                                                        </strong>
                                                    </span>
                                                    <?php
                                                }
