...
$RadicadoRecibido = RadicadoRecibido::Buscar(1, $_REQUEST['id_radica'], "", "", "", "");
...
foreach($TRD as $Item):
	if($Item['id_serie'] == $RadicadoRecibido -> get_IdSerie()){
		$Combo_Series.= "<option value='".$Item['id_serie']."' selected>".$Item['cod_serie'].".".$Item['nom_serie']."</option>";
	}else{
...
$Tercero = "";
$RadicadoTercero = Tercero::Listar(2, $RadicadoRecibido->get_IdRemite(), "", "" ,"", "", "");
foreach ($RadicadoTercero as $ItemRemitentre) {
	if($ItemRemitentre['razo_soci'] != ''){
		$Tercero = $ItemRemitentre['razo_soci'].", ".$ItemRemitentre['nom_contac'];
	}else{
		$Tercero = $ItemRemitentre['nom_contac'];
	}
}
...
$TerceroContacto = Tercero::Buscar(2, $RadicadoRecibido->get_IdRemite(), "", "" ,"", "", "");
$TerceroEmpresa  = TerceroEmpresa::Buscar(2, $TerceroContacto->getId_Empresa(), "", "" ,"", "", "");

if($TerceroContacto->getId_Empresa() == ""){
	$TerceCcNit      = $TerceroContacto->getNum_Documetno();
	$TerceContacto   = $TerceroContacto->getNom_Contacto();
	$TerceDir        = $TerceroContacto->get_Dir();
	$TerceTel        = $TerceroContacto->get_Tel();
	$TerceMovil      = $TerceroContacto->get_Cel();
}else{
	$TerceCcNit      = $TerceroEmpresa->get_Nit();
	$TerceContacto   = $TerceroContacto->getNom_Contacto();
	$TerceRazonSoial = $TerceroEmpresa->get_RazonSocial();
	$TerceDir        = $TerceroEmpresa->get_Dir();
	$TerceTel        = $TerceroEmpresa->get_Tel();
	$TerceMovil      = $TerceroEmpresa->get_Cel();
}
...
$Combo_FuncionariosFirman = "";
foreach($FuncionarioFirman as $Item):
	$Combo_FuncionariosFirman.= "<option value='".$Item['id_funcio_deta']."'>".$Item['nom_oficina']." - ".$Item['nom_funcio']." ".$Item['ape_funcio']."</option>";
endforeach;
...
$Combo_Radicado_Respuesta = "<option value='".$RadicadoRecibido->get_IdRadica()."'>".$RadicadoRecibido->get_IdRadica()."</option>";

$de_donde_viene = "";
if(isset($_REQUEST['Origen'])){
	$de_donde_viene = "CREAR_GRUPO_COLABORATIVO";
}
?>
<!DOCTYPE html>
<html>
		...
		<div class="page-sidebar mini mini-mobile" id="main-menu" data-inner-menu="1">
			...
			<div class="page-content">
				...
				<div class="content">
					<ul class="breadcrumb">
						...
						<li><a href="#" class="active">Bandeja, Correspondencia recibida, responder comunicación</a> </li>
					</ul>
					<div class="page-title">
						<div id="DivAlertas"></div>
					</div>
					<form role="form" name="FrmDatosResponder" id="FrmDatosResponder">

						<input type="hidden" id="id_temp" name="id_temp">
						<input type="hidden" id="id_depen" name="id_depen">
						...
						<input type="hidden" id="id_destina" name="id_destina" value="<?php echo $RadicadoRecibido -> get_IdRemite(); ?>">
						<input type="hidden" id="id_radica_respues" name="id_radica_respues" value="<?php echo $_REQUEST['id_radica']; ?>">
						...
						<input name="de_donde_viene" type="hidden" id="de_donde_viene" value="<?php echo $de_donde_viene; ?>">
									...
									<div class="col-md-8">
										<div class="grid simple">
											<div class="grid-body no-border">
												<div class="row-fluid ">
													<h2>Responder Correspondencia - <?php echo $RadicadoRecibido->get_IdRadica(); ?></h2>
													<div class="row">
														<div class="form-group col-md-12">
															<input type="text" class="form-control " placeholder="Para quien va dirigido" id="TxtDestinatarios" value="<?php echo $Tercero; ?>">
														</div>
													</div>
													<div class="row">
														<div class="form-group col-md-12">
															<input type="text" class="form-control " placeholder="Ingrese aqui el asunto" id="asunto" value="<?php echo "Respuesta del radicado ".$RadicadoRecibido->get_IdRadica()." - ".$RadicadoRecibido->get_asunto(); ?>">
														</div>
													</div>
													<div class="row">
											...
											<div class="grid-body no-border" style="min-height: 290px;">
												<div class="row">
													<div class="form-group col-md-3">
														<input name="id_destina" id="id_destina" type="hidden" value="<?php echo $RadicadoRecibido->get_IdRemite(); ?>">
														<input name="cc_nit" type="text" class="form-control" id="cc_nit" placeholder="C.c / NIt" value="<?php echo $TerceCcNit; ?>">
													</div>
													<div class="form-group col-md-7">
														<input name="remite_contacto" type="text" class="form-control" id="remite_contacto" placeholder="Contacto" value="<?php echo $TerceContacto; ?>">
													</div>
												...
												<div class="row" id="DivOcultarRemiteRazoSoci">
													<div class="form-group col-md-12">
														<input name="remite_razo_soci" type="text" class="form-control" id="remite_razo_soci" placeholder="Razón Social" value="<?php echo $TerceRazonSoial; ?>">
													</div>
												</div>
												<div class="row">
													<div class="form-group col-md-12">
														<input name="remite_dir" type="text" class="form-control" id="remite_dir" placeholder="Dirección" value="<?php echo $TerceDir; ?>">
													</div>
												</div>
												<div class="row">
													<div class="form-group col-md-3">
														<input name="remite_tel" type="text" class="form-control" id="remite_tel" placeholder="Teléfono" value="<?php echo $TerceTel; ?>">
													</div>
													<div class="form-group col-md-3">
														<input name="remite_cel" type="text" class="form-control" id="remite_cel" placeholder="Móvil / Pbx" value="<?php echo $TerceMovil; ?>">
													</div>
													<div class="form-group col-md-6">
														<input name="remite_email" type="text" class="form-control" id="remite_email" placeholder="Email" value="<?php echo $TerceMovil; ?>">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="grid simple">
											<div class="grid-title no-border">
												<h4>
													...
													<span class="semi-bold text-info">Radicados para responder</span>
												</h4>
											</div>
											<div class="grid-body no-border" >
												<div class="row-fluid">
													<div class="row">
														...
														<div class="form-group col-md-10">
															<select name="multi2" id="multi2" style="width:100%">
																<?php echo $Combo_Radicado_Respuesta; ?>
															</select>
														</div>
														<noscript>
															<div class="form-group col-md-2">
														...
														<div class="row">
															<div class="form-group col-md-12">
																<select name="id_subserie" id="id_subserie" style="width:100%">
																	<option value="0">...::: SubSerie :::...</option>
														...
														<div class="row">
															<div class="form-group col-md-12">
																<select name="id_tipodoc" id="id_tipodoc" style="width:100%">
																	<option value="0">...::: Tipo Documental :::...</option>
				...
				<div class="admin-bar" id="quick-access" style="display:">
					<div class="admin-bar-inner">
						...
						<noscript>
							<button class="btn btn-success btn-cons" type="button" id="BtnDescargaPlantilla"><i class="fa fa-cloud-download"></i> Generar Plantilla</button>
						</noscript>
			...
			<script type="text/javascript">
				$.post("../../../../varios/combo_sub_series.php", {
					...
					id_subserie: <?php echo $RadicadoRecibido -> get_IdSubserie(); ?>
				}, function (data) {
				...
				$.post("../../../../varios/combo_tipos_documentos.php", {
					id_depen: <?php echo $_SESSION['SesionFuncioDepenId']; ?>,
					id_serie: $("#id_serie").val(),
					id_sub_serie: <?php echo $RadicadoRecibido -> get_IdSubserie(); ?>
				}, function (data) {
