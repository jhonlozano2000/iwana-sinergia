                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="grid simple">
                                <div class="grid-title no-border">
                                    <h4>
                                        <span class="semi-bold">
                                            <span class="text-success">Mis archivos</span>
                                        </span> digitalizados.
                                    </h4>
                                </div>
                                <div class="grid-body no-border" style="min-height: 850px;">
                                    <ul id="menu1">
                                        <?php
                                        $AccesoDependicias = FuncionarioAccesoDigital::Listar(2, $_SESSION['SesionFuncioDetaId'], "", "", "");
                                        foreach ($AccesoDependicias as $ItemDepen) {
                                        ?>
                                            <li>
                                                <?php
                                                echo trim($ItemDepen['nom_depen']);
                                                ?>
                                                <ul>
                                                    <?php
                                                    $AccesoSeriesDigitales = FuncionarioAccesoDigital::Listar(3, $_SESSION['SesionFuncioDetaId'], $ItemDepen['id_depen'], "", "");
                                                    foreach ($AccesoSeriesDigitales as $ItemSeries) {
                                                    ?>
                                                        <li>
                                                            <?php
                                                            echo trim($ItemSeries['cod_serie']) . "." . trim($ItemSeries['nom_serie']);
                                                            ?>
                                                            <ul>
                                                                <?php
                                                                $AccesoSubSeriesDigitales = FuncionarioAccesoDigital::Listar(4, $_SESSION['SesionFuncioDetaId'], $ItemDepen['id_depen'], $ItemSeries['id_serie'], "");
                                                                foreach ($AccesoSubSeriesDigitales as $ItemSubSeries) {
                                                                ?>
                                                                    <li>
                                                                        <?php
                                                                        echo trim($ItemSubSeries['cod_subserie']) . "." . trim($ItemSubSeries['nom_subserie']);
                                                                        ?>
                                                                        <ul>
                                                                            <?php
                                                                            $Expediente = Digitalizacion::Listar(2, "", $ItemDepen['id_depen'], $ItemSeries['id_serie'],  $ItemSubSeries['id_subserie'], "", "", "", "", "");
                                                                            foreach ($Expediente as $ItemExpediente) {
                                                                            ?>
                                                                                <li>
                                                                                    <a href="#" id="BtnExpediente" data-id_expediente="<?php echo $ItemExpediente['id_digital']; ?>">
                                                                                        <?php echo "Cod.: " . $ItemExpediente['codigo'] . "<br>Expe.: " . $ItemExpediente['titulo']; ?>
                                                                                    </a>
                                                                                </li>
                                                                            <?php
                                                                            }
                        ...
                        <div class="col-md-8">
                            <div class="grid simple">
                                ...
                                <div class="grid-body no-border" style="min-height: 850px;">
                                    <div id="DivDetalleExpediente"></div>
                                </div>
                            </div>
                        </div>
                    </div>
