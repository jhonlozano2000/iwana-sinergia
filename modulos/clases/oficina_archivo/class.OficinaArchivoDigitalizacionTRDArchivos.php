<?php
class DigitalizacionTRDArchivos{
	private $Accion;
	private $IdArchivo;
	private $IdDigital;
	private $IdTomo;
	...
	public function Gestionar(){
		...
		try{
			if($this->Accion == 'INSERTAR_ARCHIVO'){
				$Sql = "INSERT INTO archivo_digitales_trd_detalle(id_digital, id_tomo, id_ruta, id_tipodoc, archivo, folios, detalle, fecha, tipo)
				...
				$Sql = "UPDATE archivo_digitales_trd_detalle 
				...
				$Sql = "DELETE FROM archivo_digitales_trd_detalle
						WHERE id_archivo = :id_archivo";
	...
	public static function Listar($Accion, $IdArchivo, $IdDigital, $IdTomo, $Archivo, $IdTipoDocu){
		...
		try{
			...
			if($Accion == 1){
				...
				*********************************************************************************************/
				$Sql = "SELECT *
						FROM archivo_digitales_trd_detalle
