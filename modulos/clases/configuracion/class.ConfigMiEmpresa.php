...
class MiEmpresa{
	...
	public function __construct($Accion = null, $Nit = null, $RazonSocial = null, $Slogan = null, $IdDepartamento = null, $IdMunicipio = null, 
		$Dir = null, $Tel = null, $Cel = null, $Email = null, $Web = null, $Logo = null){
...
/////////////////////////////////////
	...
	public static function Buscar() {
		...
		$conexion = null;
		if ($Result) {
			return new self("", $Result['nit'],  $Result['razo_soci'], $Result['slogan'], $Result['id_depar'], $Result['id_muni'], $Result['dir'], $Result['tel'], 
				$Result['cel'], $Result['email'], $Result['web'], $Result['logo']);
		} else {
			return false;
		}
	}
