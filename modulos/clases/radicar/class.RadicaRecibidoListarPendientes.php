    ...
    public function Listar(){
        ...
        try{
            ...
            if($this->Accion == 1){
                ...
                /******************************************************************************************/
                $Sql = "SELECT `radi`.`id_radica`, `radi`.`fechor_radica`, `radi`.`fec_docu`, `radi`.`fec_venci`, `radi`.`asunto`, `radi`.`impri_rotu`, 
                            `radi`.`digital`, `radi`.`requie_respues`, `radi`.`autoriza`, `funcio`.`nom_funcio`, `funcio`.`ape_funcio`, `ofi`.`nom_oficina`, 
                ...
                $Sql = "SELECT `radi`.`id_radica`, `radi`.`fechor_radica`, `radi`.`fec_docu`, `radi`.`fec_venci`, `radi`.`asunto`, `radi`.`impri_rotu`, 
                            ...
                            `terce_contac`.`nom_contac`, `terce_contac`.`cargo`, `terce_empre`.`nit_empre`, `terce_empre`.`razo_soci`, 
                            `funcio_radica`.`nom_funcio` AS `nom_funcio_radi`, `funcio_radica`.`ape_funcio` AS `ape_funcio_radi`, `radi`.`radica_respuesta`, 
                            `radi`.`id_forma_llegada`, `forma_llega`.`nom_formaenvi` AS `nom_forma_llega`, `forma_llega`.`requie_digital`
                        FROM `archivo_radica_recibidos_responsa` AS `ra_respon`
                            INNER JOIN `archivo_radica_recibidos` AS `radi` ON (`ra_respon`.`id_radica` = `radi`.`id_radica`)
                            INNER JOIN `gene_terceros_contac` AS `terce_contac` ON (`radi`.`id_remite` = `terce_contac`.`id_tercero`)
                            INNER JOIN `segu_usua` AS `usua_radica` ON (`radi`.`id_usua_regis` = `usua_radica`.`id_usua`)
                            ...
                            INNER JOIN `gene_funcionarios` AS `funcio_radica` ON (`usua_radica`.`id_funcio` = `funcio_radica`.`id_funcio`)
                            INNER JOIN `config_formaenvio` AS `forma_llega` ON (`radi`.`id_forma_llegada` = `forma_llega`.`id_formaenvio`)
                        WHERE (`radi`.`transferido` = 0 AND `ra_respon`.`respon` = 1 AND `radi`.`digital` = 0 OR `radi`.`impri_rotu` = 0 AND `radi`.`digital` = 0 OR `radi`.`impri_rotu` = 0)
                        ORDER BY `radi`.`fechor_radica` DESC 
                        LIMIT :Criterio1, :Criterio2";
            ...
            if($this->Accion == 5){
                ...
                $Sql = "SELECT `radi`.`id_radica`, `radi`.`fechor_radica`, `radi`.`fec_docu`, `radi`.`fec_venci`, `radi`.`asunto`, `radi`.`impri_rotu`, 
                        ...
                        FROM `archivo_radica_recibidos_responsa` AS `ra_respon`
                            ...
                            INNER JOIN `gene_funcionarios` AS `funcio_radica` ON (`usua_radica`.`id_funcio` = `funcio_radica`.`id_funcio`)
                            INNER JOIN `config_formaenvio` AS `forma_llega` ON (`radi`.`id_forma_llegada` = `forma_llega`.`id_formaenvio`)
                        WHERE (`radi`.`transferido` = 0 AND `ra_respon`.`respon` = 1  AND `radi`.`digital` = 0 OR `radi`.`impri_rotu` = 0 ".self::Generar_Query_Correspondencia($this->Criterio3).")
                        ORDER BY `radi`.`fechor_radica` DESC
                        LIMIT :Criterio1, :Criterio2";
                ...
                $Sql = "SELECT `radi`.`id_radica`, `radi`.`fechor_radica`, `radi`.`fec_docu`, `radi`.`fec_venci`, `radi`.`asunto`, `radi`.`impri_rotu`, 
                        ...
                        FROM `archivo_radica_recibidos_responsa` AS `ra_respon`
                            ...
                            INNER JOIN `gene_funcionarios` AS `funcio_radica` ON (`usua_radica`.`id_funcio` = `funcio_radica`.`id_funcio`)
                            INNER JOIN `config_formaenvio` AS `forma_llega` ON (`radi`.`id_forma_llegada` = `forma_llega`.`id_formaenvio`)
                        WHERE (`radi`.`transferido` = 0 AND `radi`.`autoriza` = 1 AND `ra_respon`.`respon` = 1 AND `ra_respon`.`id_funcio` = :id_funcio  AND `radi`.`digital` = 0 OR `radi`.`impri_rotu` = 0 ".self::Generar_Query_Correspondencia($this->Criterio3).")
                        ORDER BY `radi`.`fechor_radica` DESC
                        LIMIT :Criterio1, :Criterio2";
                ...
                $Sql = "SELECT `radi`.`id_radica`, `radi`.`fechor_radica`, `radi`.`fec_docu`, `radi`.`fec_venci`, `radi`.`asunto`, `radi`.`impri_rotu`, 
                        ...
                        FROM `archivo_radica_recibidos_responsa` AS `ra_respon`
                            ...
                            INNER JOIN `config_formaenvio` AS `forma_llega` ON (`radi`.`id_forma_llegada` = `forma_llega`.`id_formaenvio`)
                        WHERE (`radi`.`transferido` = 0 AND `radi`.`autoriza` = 1 AND `ra_respon`.`respon` = 1 AND `depen`.`id_depen` = :id_depen 
                            AND `radi`.`digital` = 0 OR `radi`.`impri_rotu` = 0 ".self::Generar_Query_Correspondencia($this->Criterio3).")
                        ORDER BY `radi`.`fechor_radica` DESC
                        LIMIT :Criterio1, :Criterio2";
                ...
                $Sql = "SELECT `radi`.`id_radica`, `radi`.`fechor_radica`, `radi`.`fec_docu`, `radi`.`fec_venci`, `radi`.`asunto`, `radi`.`impri_rotu`, 
                        ...
                        FROM `archivo_radica_recibidos_responsa` AS `ra_respon`
                            ...
                            INNER JOIN `config_formaenvio` AS `forma_llega` ON (`radi`.`id_forma_llegada` = `forma_llega`.`id_formaenvio`)
                        WHERE (`radi`.`transferido` = 0 AND `radi`.`autoriza` = 1 AND `ra_respon`.`respon` = 1 AND `depen`.`id_depen` = :id_depen 
                            AND `funcio_deta`.`id_oficina` = :id_oficina  AND `radi`.`digital` = 0 OR `radi`.`impri_rotu` = 0 ".self::Generar_Query_Correspondencia($this->Criterio3).")
                        ORDER BY `radi`.`fechor_radica` DESC
                        LIMIT :Criterio1, :Criterio2";
            ...
            if($this->Accion == 1){
                ...
                $Sql = "SELECT `radi`.`id_radica`
                        FROM `archivo_radica_recibidos_responsa` AS `ra_respon`
                            ...
                            INNER JOIN `config_formaenvio` AS `forma_llega` ON (`radi`.`id_forma_llegada` = `forma_llega`.`id_formaenvio`) 
                        WHERE (`radi`.`transferido` = 0 AND `radi`.`autoriza` = 1 AND `ra_respon`.`respon` = 1  AND `radi`.`digital` = 0 OR `radi`.`impri_rotu` = 0 AND `depen`.`id_depen` = ? 
                            AND `funcio_deta`.`id_oficina` = ? OR".self::Generar_Query_Correspondencia($this->Criterio3).")";
            ...
            if($this->Accion == 1){
                ...
                $Sql = "SELECT `radi`.`id_radica`
                        FROM `archivo_radica_recibidos_responsa` AS `ra_respon`
                            ...
                            INNER JOIN `gene_funcionarios` AS `funcio_radica` ON (`usua_radica`.`id_funcio` = `funcio_radica`.`id_funcio`)
                            INNER JOIN `config_formaenvio` AS `forma_llega` ON (`radi`.`id_forma_llegada` = `forma_llega`.`id_formaenvio`) 
                        WHERE (`radi`.`transferido` = 0 AND `radi`.`autoriza` = 1 AND `ra_respon`.`respon` = 1  AND `radi`.`digital` = 0 OR `radi`.`impri_rotu` = 0 AND `depen`.`id_depen` = ? AND `funcio_deta`.`id_oficina` = ? OR".self::Generar_Query_Correspondencia($this->Criterio3).")";
