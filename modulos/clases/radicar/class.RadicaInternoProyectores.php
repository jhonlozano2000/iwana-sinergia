<?php
class RadicadoInternoProyector{
//Atributos
    private $Accion;
    private $IdRadicado;
    private $IdFuncio;
    ...
    public function Gestionar(){
        ...
        try{
            if($this->Accion == 'NUEVO_PROYECTOR'){
                $Sql = 'INSERT INTO archivo_radica_interna_proyectores(id_radica, id_funcio_deta, fechor_asigna)
        ...
        try{
            if($Accion == 1){
                ...
                $Sql = "SELECT `radi_proyec`.`id_radica`, `proyec`.`nom_funcio`, `proyec`.`ape_funcio`, `ofi`.`nom_oficina`, `depn`.`nom_depen`
                        FROM `archivo_radica_interna_proyectores` AS `radi_proyec`
    ...
    public static function Buscar($Accion, $IdRadicado, $IdFuncioDeta){
        ...
        try{
            if($Accion == 1){
                ...
                /******************************************************************************************/
                $Sql = "SELECT * 
                        FROM archivo_radica_interna_proyectores 
