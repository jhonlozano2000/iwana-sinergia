	...
	public function Gestionar(){
        ...
        try{
    		...
    		if($this->Accion == 'COMPARTIR_RADICADO'){
    			...
    			$Sql = 'INSERT INTO `archivo_radica_recibido_compartir`(`id_radica`, `id_funcio_deta_origen`, `id_funcio_deta_destino`, `fechor_compartido`)
                ...
                $Sql = "DELETE FROM archivo_radica_recibido_compartir 
