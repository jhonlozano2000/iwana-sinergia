<?php
class RadicadoRecibidoPQRSFListarBandeja{
    private $Accion;
    ...
    public function __construct($Accion = null, $IdFuncioSesion = null, $Buscar = null, $IdRadica = null, $IdFuncioDeta = null, $IdTercero = null,
                            $Asunto = null, $QueContenga = null, $IdDepen = null, $IdOfi = null, $Limite1 = null, $Limite2 = null, $Criterio1 = null){
    ...
    public static function Generar_Query_Correspondencia($Buscar, $IdRadica, $IdTercero, $IdFuncio, $Asunto, $QueContenga, $IdDepen, $IdOfi){
        ...
        if($Buscar != "" and $IdRadica == "" and $IdTercero == "" and $IdFuncio == "" and $Asunto == "" and $QueContenga == "" and $IdDepen == ""
             and $IdOfi == ""){
