			...
			<div class="row login-container animated fadeInUp">
				<div class="col-md-4 col-md-offset-4 tiles white no-padding">
					...
					<div class="p-t-20 p-l-30 p-b-10 xs-p-t-5 xs-p-l-5 xs-p-b-5">
						<h2 class="normal">Recuerda tu contraseña de Iwana</h2>
					</div>
					<div class="tiles grey p-t-20 p-b-20 text-black">
						<form id="frm_login" class="animated fadeIn">
							...
							<div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
								<div class="col-md-12 col-sm-12">
									<input name="e_mail" type="text"  class="form-control" id="e_mail" 
										placeholder="Correo electrónico">
								</div>
							</div>
							<div class="row p-t-10 m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
								<div class="control-group  col-md-12">
									<button type="button" class="btn btn-primary btn-cons" id="BtnCambiaContra">Recordar</button> or&nbsp;&nbsp;
