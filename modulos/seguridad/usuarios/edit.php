...
$Usuario  = Usuario::Buscar(1, $_REQUEST['id'], "", "", "", 0, 0, 0);
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                ...
                <form role="form" name="FrmDatos" id="FrmDatos">
                    ...
                    <input name="id_usua" type="hidden" id="id_usua" value="<?php echo $Usuario->getId_Usua(); ?>">
                            ...
                            <div class="grid simple">
                                <div class="grid-body no-border">
                                    <div class="row column-seperation">
                                        <div class="col-md-6">
                                            <h4><span class="text-warning">Editar</span>, Información básica del usuario</h4>
                                            <div class="row form-row">
                                                <div class="col-md-6">
                                                    <input name="cod_funcio" type="text" class="form-control" id="cod_funcio" placeholder="# De Documento" value="<?php echo $Usuario->getNum_Docu(); ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-6">
                                                    <input name="nom_funcio" type="text" class="form-control" id="nom_funcio" placeholder="Nombre del Usuario" value="<?php echo $Usuario->getNom_Funcio(); ?>" disabled>
                                                </div>
                                                <div class="col-md-6">
                                                    <input name="ape_funcio" type="text" class="form-control" id="ape_funcio" placeholder="Apellidos del Usuario" value="<?php echo $Usuario->getApe_Funcio(); ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-6">
                                                    <input name="login" type="text" class="form-control" id="login" placeholder="Login" value="<?php echo $Usuario->getLogin(); ?>">
                                                </div>
                                                <div class="col-md-6">
                                                    <input name="contra" type="text" class="form-control" id="contra" placeholder="Contraseña">
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-5">
                                                    <div class="checkbox check-success  ">
                                                        <?php
                                                        if ($Usuario->getActi() == 1) {
                                                            $checked = "checked";
                                                        } else {
                                                            $checked = "";
                                                        }
                                                        ?>
                                                        <input name="acti" id="acti" type="checkbox" <?php echo $checked; ?>>
                                                        <label for="acti">Activo</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class="checkbox check-success ">
                                                        <input id="cambio_contra" type="checkbox" name="cambio_contra" class="Cambo_Contra">
                                                ...
                                                <div class="row form-row">
                                                    <div class="col-md-12">
                                                        ...
                                                        foreach ($Perfiles as $Item) :
                                                            $PerfilActivo = Usuario::Buscar(9, $_REQUEST['id'], "", "", "", 0, 0, $Item['id_perfil']);
                                                            if ($PerfilActivo) {
                                                                $checked = "checked";
                                                            } else {
                                                                $checked = "";
                                                        ...
                                                        ?>
                                                            <div class="checkbox check-success">
                                                                <input type="checkbox" value="<?php echo $Item['id_perfil']; ?>" name="ChkPerfiles[]" id="ChkPerfiles<?php echo $Item['id_perfil']; ?>" <?php echo $checked; ?>>
                                    ...
                                    <div class="form-actions">
                                        <div class="pull-left">
                                            <button class="btn btn-warning btn-cons" type="button" id="BtnEditarUsuario" name="BtnEditarUsuario">
