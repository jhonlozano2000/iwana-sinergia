                                            ...
                                            <table class="table table-striped" id="example1" >
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width: 65%">Funcionario</th>
                                                        <th></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                    $Usuario = Usuario::Listar(4, 0, "", "", "", 0, 0, 0);
                                                    foreach ($Usuario as $item):
                                                        ?>
                                                        <tr id="TrDatos<?php echo $item['id_usua']; ?>">
                                                            <td>
                                                                <div class="checkbox check-success">
                                                                    ...
                                                                    ?>
                                                                    <input id="acti<?php echo $item['id_usua']; ?>" class="acti" type="checkbox" <?php echo $checked; ?> data-id="<?php echo $item['id_usua']; ?>" data-nom="<?php echo $item['nom_funcio']." ".$item['ape_funcio']; ?>">
                                                                    <label for="acti<?php echo $item['id_usua']; ?>"></label>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <a href="edit.php?id=<?php echo $item['id_usua']; ?>" class="btn btn-warning btn-circle">
                                                                        <i class="glyphicon glyphicon-pencil"></i>
                                                                    </a>
                                                                    <button type="button" class="btn btn-danger btn-circle" id="BtnEliminar" data-id="<?php echo $item['id_usua']; ?>" data-nom="<?php echo $item['login']; ?>">
