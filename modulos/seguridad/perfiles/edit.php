        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                ...
                <form role="form" name="FrmDatos" id="FrmDatos">
                    ...
                    <input name="id_perfil" type="hidden" id="id_perfil" value="<?php echo $Perfiles->getId_Perfil(); ?>">
                            ...
                            <div class="grid simple">
                                <div class="grid-body no-border">
                                    <div class="row column-seperation">
                                        <div class="col-md-6">
                                            ...
                                            <div class="row form-row">
                                                <div class="col-md-12">
                                                    <input name="nom_perfil" type="text" class="form-control" id="nom_perfil" placeholder="Nombre del perfil" value="<?php echo $Perfiles->getNom_Perfil(); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-12">
                                                    <textarea name="observa" rows="3" class="form-control" id="observa" placeholder="Observaciones si las hay..."><?php echo $Perfiles->getObserva(); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-5">
                                    ...
                                    <div class="form-actions">
                                        <div class="pull-left">
                                            <button class="btn btn-warning btn-cons" type="button" id="BtnEditarPerfil" name="BtnEditarPerfil">
