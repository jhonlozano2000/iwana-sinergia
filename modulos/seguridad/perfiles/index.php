...
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Seguridad, Perfiles :::...</title>
                                                        ...
                                                        <tr id="TrDatos<?php echo $item['id_perfil']; ?>">
                                                            <td>
                                                                <div class="checkbox check-success">
                                                                    ...
                                                                    ?>
                                                                    <input id="acti<?php echo $item['id_perfil']; ?>" class="acti" type="checkbox" <?php echo $checked; ?> data-id="<?php echo $item['id_perfil']; ?>" data-nom="<?php echo $item['nom_perfil']; ?>">
                                                                    <label for="acti<?php echo $item['id_perfil']; ?>"></label>
                                                                </div>
                                                            </td>
                                                            <td><?php echo $item['nom_perfil']; ?></td>
