        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="#" class="active">Caldiad, Procesos.</a>
                    </li>
                </ul>
                            ...
                            <div class="grid simple">
                                ...
                                <div class="grid-body no-border">
                                    <div class="row column-seperation">
                                        <div class="col-md-6">
                                            <h4><span class="text-success">Nueva, </span>Información básica del procesos</h4>
                                            ...
                                            <div class="row form-row">
                                                <div class="col-md-12">
                                                    <input name="nom_proce" type="text" class="form-control" id="nom_proce" placeholder="Nombre del proceso">
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-8">
