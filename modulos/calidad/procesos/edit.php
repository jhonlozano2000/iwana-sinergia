...
$Cargo = Cargo::Buscar(2, $_REQUEST['id'], 0, "");
...
foreach($Dependencia as $Item):
    if($Item['id_depen'] == $Cargo->getId_Dependencia()){
                ...
                <form role="form" name="FrmDatos" id="FrmDatos">
                    <div class="grid simple">
                        <div class="grid-body no-border">
                            ...
                            <input name="id_cargo" id="id_cargo" type="hidden" value="<?php echo $Cargo -> getId_Cargo(); ?>">
                            <input name="accion" id="accion" type="hidden" value="EDITAR">

                            <div class="row column-seperation">
                                <div class="col-md-6">
                                    <h4><span class="text-warning">Editar</span>, Información básica del Cargo</h4>
                                    ...
                                    <div class="row form-row">
                                        <div class="col-md-12">
                                            ...
                                            value="<?php echo $Cargo -> getNom_Cargo(); ?>">
                                        </div>
                                    </div>
                                    <div class="row form-row">
                                        <div class="col-md-12">
                                            ...
                                            <?php echo trim($Cargo -> getObserva()); ?>
                                        </textarea>
                                    </div>
                                </div>
                                <div class="row form-row">
