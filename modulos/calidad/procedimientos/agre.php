        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="#" class="active">Caldiad, Procedimientos.</a>
                    </li>
                </ul>
                            ...
                            <div class="grid simple">
                                ...
                                <div class="grid-body no-border">
                                    <div class="row column-seperation">
                                        <div class="col-md-6">
                                            <h4><span class="text-success">Nueva, </span>Información básica del procedimiento</h4>
                                            ...
                                            <div class="row form-row">
                                                <div class="col-md-12">
                                                    <input name="cod_procedimiento" type="text" class="form-control" id="cod_procedimiento" placeholder="Código del procedimiento">
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-12">
                                                    <input name="nom_procedimiento" type="text" class="form-control" id="nom_procedimiento" placeholder="Nombre del procedimiento">
                                                </div>
                                            </div>
                                            <div class="row form-row">
                                                <div class="col-md-8">
