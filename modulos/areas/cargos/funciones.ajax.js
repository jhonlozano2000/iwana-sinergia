$(document).ready(function () {
    ...
    $("#BtnGuardar").click(function () {
        if ($("#id_depen").val() == 0) {
            ...
            $.ajax({
                ...
                data: "accion=Insertar&id_depen=" + $("#id_depen").val() + "&nom_cargo=" + $("#nom_cargo").val() + "&observa=" + $("#observa").val() + "&acti=" + acti,
                beforeSend: function () {
    ...
    $("#BtnEditar").click(function () {
        swal(
            {
                title: "¿Desea editar el registro: " + $("#nom_cargo").val() + "?",
                type: "info",
        ...
        swal(
            ...
            function () {
                $.ajax({
                    url: "acciones.ajax.php",
                    type: "POST",
                    data: "accion=ACTIVAR_INACTIVAR&id_cargo=" + Id + "&acti=" + Acti,
                    beforeSend: function () {
                        $("#DivAlerta").html('<div class="alert alert-info"><button class="close" data-dismiss="alert"></button><a href="#" class="link"><img src="../../../public/assets/img/loading.gif" width="20" height="20"> Info.:</a> Enviando informacóm, por favor espere. </div>');
                    },
                    success: function (msj) {
