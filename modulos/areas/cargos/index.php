...
<head>
    ...
    <meta charset="utf-8" />
    <title>...::: Iwana - Areas, Cargos :::...</title>
        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Áreas - Cargos.</a> </li>
                </ul>
                                            ...
                                            <table class="table table-striped" id="example1" >
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($Cargos as $item):
                                                        ?>
                                                        <tr id="TrDatos<?php echo $item['id_cargo']; ?>">
                                                            <td>
                                                                <div class="checkbox check-success">
                                                                    ...
                                                                    ?>
                                                                    <input id="acti<?php echo $item['id_cargo']; ?>" class="acti" type="checkbox" <?php echo $checked; ?> data-id="<?php echo $item['id_cargo']; ?>" data-nom="<?php echo $item['nom_cargo']; ?>">
                                                                    <label for="acti<?php echo $item['id_cargo']; ?>"></label>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <a href="edit.php?id=<?php echo $item['id_cargo']; ?>" class="btn btn-warning btn-circle">
                                                                    <i class="glyphicon glyphicon-pencil"></i>
                                                                </a>
                                                                <button type="button" class="btn btn-danger btn-circle" id="BtnEliminar" data-id="<?php echo $item['id_cargo']; ?>" data-nom="<?php echo $item['nom_cargo']; ?>">
