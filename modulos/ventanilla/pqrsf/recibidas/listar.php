...
if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
    ...
    require_once '../../../clases/radicar/class.RadicaRecibidoPQRSFListarBandeja.php';
    ...
    if($action == 'ajax'){
        ...
        $Registro = new RadicadoRecibidoPQRSFListarBandeja();
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            foreach ($Responsable as $ItemRespon):
                                                ...
                                                $array = explode(" ", $item['ape_funcio']);
                                                $NomResponsable = $item['nom_funcio']." ".$array[0];
                                                ?>
                                                <dl class="row">
                                        ...
                                        <div class="col-md-2">
                                            <dl class="row">
                                                ...
                                                if($item['fec_venci'] != ""){
                                                    ?>
                                                    <button type="button" class="btn btn-warning btn-xs btn-mini btn-circle" title="Notificar via correo electronico">
