...
<body class="inner-menu-always-open extended-layout">
            ...
            <div class="inner-menu nav-collapse">
                <div id="inner-menu">
                    <div class="inner-wrapper">
                        <a href="../enviadas - Copia/radicar.php" class="btn btn-block btn-primary">
                    ...
                    <ul class="small-items">
                        ...
                        <li class="active">
                            <a href="../enviadas - Copia/index.php"> Ir a la correspondencia enviada</a>
                        </li>
                        <li class="active">
                    ...
                    <ul class="big-items">
                        ...
                        <li class="">
                            <a href="../pendien_radicar/index.php">
                                <span class="btn btn-success btn-sm btn-small label label-important">
        ...
        <div class="page-content">
            ...
            <div class="content">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Mis Pendientes</a> </li>
                </ul>
    ...
    <script src="../enviadas - Copia/funciones.ajax.js"></script>
