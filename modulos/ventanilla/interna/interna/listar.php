                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <button type="button" class="btn btn-success btn-circle"
                                                data-toggle="modal" data-target="#myModalMostrarInfoRadicadoInterno"
                                                id="BtnMostarInfoRadicadoInterno"
                                                data-id_radicado="<?php echo $item['id_radica']; ?>"
                                                data-nombre_archivo="<?php echo $item['nombre_archivo']; ?>"
                                                data-tipo_cargue_archivos="<?php echo $item['tipo_cargue_archivos']; ?>"
                                                data-id_ruta="<?php echo $item['id_ruta']; ?>"
                                                title="Info. del radicado">
