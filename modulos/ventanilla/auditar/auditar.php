...
if($ConfiguracionOtras->get_Incluir_TRD() == 0){
    ...
    $Documentos = TipoDocumento::RecuperarTodos();
...
<body class="inner-menu-always-open">
            ...
            <div class="inner-menu nav-collapse">   
                <div id="inner-menu">
                    ...
                    <ul class="small-items">
                        <li class="">
                            <a href="../recibida/recibidas/index.php"> Regresas a la correspondencia recibida</a>
                        </li>
                         <li class="">
                            <a href="../recibida/pendientes/index.php"> 
                        ...
                        <li class="">
                            <a href="../recibida/alertas/index.php">
        ...
        <div class="page-content">
            ...
            <div class="content">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="#" class="active">Radicar - Correspondencia recibida.</a>
                    </li>
                </ul>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <textarea name="asunto" rows="2" class="form-control" id="asunto" placeholder="Ingrese aquí el asunto del documento...">
                                                    <?php echo $RadicadoRecibido->get_asunto(); ?>
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="grid simple">
                                    <div class="grid-title no-border">
                                        <div class="col-md-8">
                                            <h4><i class="fa fa-users text-info"></i><span class="semi-bold text-info">Destino Del Documento</span>
                                            </h4>
                                        </div>
                                        <div class="col-md-4">
                                            <div align="right">
                                                ...
                                                <tr>
                                                    <td class="v-align-middle">
                                                        <div class="checkbox check-default">
                                                            ...
                                                            data-dependencia_destinatario="<?php echo $Item['id_depen']; ?>">
    ...
    <!-- END MODAL PARA LOS TERCEROS JURIDICO-->
