        ...
        <div class="page-sidebar mini mini-mobile" id="main-menu" data-inner-menu="1">
            ...
            <div class="inner-menu nav-collapse">   
                <div id="inner-menu">
                    ...
                    <ul class="big-items">
                        <li class="">
                           <a href="../pendientes/index.php"><span class="btn btn-success btn-sm btn-small label label-important"><i class="fa fa-bell-o"></i> <span>Solicitudes de HC<br> pendientes por entregar</span></a>
                       </li>
                       <li class="">
    ...
    <div class="page-content"> 
        ...
        <div class="content"> 
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="#" class="active">Radicar - Solicitudes de historias clínicas enviadas.</a>
                </li>
            </ul>
            ...
            <div class="page-title" style="display:none"> 
                ...
                <h3>Regresar- <span class="semi-bold">Correspondencia historias clínicas enviadas</span></h3>
            </div>		
