       ...
       <div class="page-content"> 
        ...
        <div class="content"> 
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="#" class="active">Radicar - Solicitudes de historias clínicas recibidas.</a>
                </li>
            </ul>
            ...
            <div class="page-title" style="display:none"> 
                ...
                <h3>Regresar- <span class="semi-bold">Correspondencia historias clínicas recibidas</span></h3>
            </div>		
