...
foreach($RadicadoEnviado as $ItemRadicado):
	...
	foreach ($RegisResponsable as $ItemRessponsa) {
		...
		$Destinatarios.= "[".$ItemRessponsa['cod_depen']." - ".$ItemRessponsa['cod_corres_depen']." - ".$ItemRessponsa['nom_depen']."] ".$ItemRessponsa['nom_funcio']." - ".$ItemRessponsa['ape_funcio'];
	}
	?>
	<div class="row">
		...
		<div class="form-group col-md-2">
			<div class="pull-right">
				<span class="muted small-text">
					<a href="../../../reportes/ventanilla/rotulos/imprimir_rotulo_enviada.php?id_radica=<?php echo $_POST['id_radica']; ?>" target="_blank">
						<img src="<?php echo MI_ROOT; ?>/public/assets/img/impresora.png" width="40" height="36">
					</a>
				</span>
				<span class="muted small-text">
					<a href="#" id="BtnDescargarPdfEnviado" class="descargar_pdf_enviado" 
											...
											if($ItemRadicado['razo_soci'] == ""){
												...
												<tr>
													...
													<td>
														<?php 
														if($ItemRadicado['razo_soci'] != ""){
															echo $ItemRadicado['nom_depar_empre']." - ".$ItemRadicado['nom_muni_empre'].", ".$ItemRadicado['dir_destina'];
														}else{
															echo $ItemRadicado['nom_depar_remite']." - ".$ItemRadicado['nom_muni_remite'].", ".$ItemRadicado['dir_destina'];
