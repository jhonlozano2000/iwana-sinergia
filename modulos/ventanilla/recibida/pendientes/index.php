...
<body class="inner-menu-always-open extended-layout">
            ...
            <div class="inner-menu nav-collapse">
                <div id="inner-menu">
                    <div class="inner-wrapper">
                        <a href="../recibidas/radicar.php" class="btn btn-block btn-primary">
                    ...
                    <ul class="small-items">
                        <li class=""><a href="#" id="BtnReportCorrespondenPorVencer"> Pendientes por vencer</a></li>
                        <li class=""><a href="#" id="BtnReportCorresPorDigital"> Pendientes por adjuntar digital</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="page-content">
            ...
            <div class="content">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Pendientes</a></li>
                </ul>
                ...
                <div class="page-title" style="display:none">
                    ...
                    <h3>Regresar- <span class="semi-bold">Correspondencia recibida, Pendientes</span></h3>
                </div>
    ...
    <script src="funcionesVentanillaRecibidasPendientes.ajax.js"></script>
