                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            foreach ($Responsable as $ItemRespon) :
                                                ...
                                                $NomResponsable = $ItemRespon['nom_funcio'] . " " . $array[0] . "<br>" . $ItemRespon['nom_depen'] . "<br>" . $ItemRespon['nom_oficina'];
                                            ?>
                                                <dd class="col-sm-12">
                                                    <p>
                                                        <?php
                                                        if ($ItemRespon['respon'] == 1) {
                                                        ?>
                                        ...
                                        <div class="col-md-2">
                                            <dl class="row">
                                                <?php "Digital: " . $item['digital']; ?>

                                                <?php
                                                if ($item['digital'] == 0 or $item['digital'] == "" and $item['requie_digital'] == 1) {
                                                ?>
                                                ...
                                                ?>
                                                    <button type="button" class="idradicado btn btn-primary btn-xs btn-mini btn-circle idradicado" data-toggle="modal" data-target="#myModalAdjuntarDocumento" data-id_radicado="<?php echo $item['id_radica']; ?>" id="BtnAdjunarDigital<?php echo $item['id_radica']; ?>" title="Subir archivo digital">
                                                        <i class="fa fa-cloud-upload"></i>
                                                    </button>
                                                <?php
                                                }
                                                ...
                                                if ($item['fec_venci'] != "") {
                                                ?>
                                                    <button type="button" class="btn btn-warning btn-xs btn-mini btn-circle" title="Notificar via correo electronico" id="BtnNotificarPorEmail" data-id_radicado="<?php echo $item['id_radica'];; ?>" data-autoriza="<?php echo $item['autoriza'];; ?>">
                                                ...
                                                <button type="button" class="btn btn-info btn-xs btn-mini btn-circle" id="BtnLlevarEditarAsunto" data-toggle="modal" data-target="#myModalEditarRadicado" data-id_radicado="<?php echo $item['id_radica']; ?>" data-asunto="<?php echo $item['asunto']; ?>" title="Editar el asunto">
                                                ...
                                                <button type="button" class="btn btn-default btn-xs btn-mini btn-circle" id="BtnEstablecerRequiereRespues" data-id_radicado="<?php echo $item['id_radica']; ?>" data-toggle="modal" data-target="#myModalEstablecerRquiereRespues" title="Establecer si el radicado requiere respuesta">
