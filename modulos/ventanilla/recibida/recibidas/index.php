...
<body class="inner-menu-always-open extended-layout">
        ...
        <div class="page-content">
            ...
            <div class="content">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Correspondencia recibida</a></li>
                </ul>
    ...
    <!-- BEGIN MODAL PARA ESTABLECER SI EL RADICADO REQUIERE RESPUESTA -->
    <div class="modal fade" id="myModalEstablecerRquiereRespues" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 id="myModalLabel" class="semi-bold text-info">Requiere respuesta.</h4>
                </div>
                <div class="modal-body">
                    <div class="row-fluid">
                        <div id="DivAlertasEstablecerRequiereRespues"></div>
                        <div class="grid simple ">
                            <div class="grid-body">

                                <input type="date" name="new_fec_venci" id="new_fec_venci">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-warning" id="BtnActualizarNoRequiereRespuesta">No requiere respuesta</button>
                    <p role="presentation" class="divider"></p>
                    <button type="button" class="btn btn-default" data-dismiss="modal" id="BtnCerrarActualizarSiRequiereRespuesta">Cancelar</button>
                    <button type="button" class="btn btn-success" id="BtnActualizarSiRequiereRespuesta">
    ...
    <!-- END MODAL ESTABLECER SI EL RADICADO REQUIERE RESPUESTA  -->
