...
$documento->getProperties()
		...
		->setTitle('Ofi. Archivo -> Detallado de Sub Series')
		->setSubject('Reportes');

$hoja = $documento->getActiveSheet();
$hoja->setTitle("Detallado de Series y Subseries");
...
$hoja->setCellValue('B2', 'Ofi. Archivo -> Detallado de Sub Series.');
...
$nombreDelDocumento = "Reportes Detallado de Series y Sub Series.xlsx";
/**
