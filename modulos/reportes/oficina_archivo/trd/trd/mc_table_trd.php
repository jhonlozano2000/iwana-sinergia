...
class PDF_MC_Table extends FPDF
{
	...
	function Header()
	{
		...
		$this->Ln();
		$this->Cell(280,6, utf8_decode('Ofi. Archivo -> Detallado de Tablas de Retención Documental'),0,0,'C');
        ...
        $this->Cell(60,5, utf8_decode('Dependencia'),1, 0, 'C', true);
        $this->Cell(50,5, utf8_decode('Serie'),1, 0, 'C', true);
        $this->Cell(60,5, utf8_decode('Subseries'),1, 0, 'C', true);
        $this->Cell(100,5, utf8_decode('Tipo Documento'),1, 0, 'C', true);
        $this->Ln();
	}
