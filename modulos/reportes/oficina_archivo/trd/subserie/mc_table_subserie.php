...
class PDF_MC_Table extends FPDF
{
	...
	function Header()
	{
		...
		$this->Ln();
		$this->Cell(190,6, 'Ofi. Archivo -> Detallado de Sub Series',0,0,'C');
        ...
        $this->Cell(100,5, utf8_decode('SubSerie'),1, 0, 'C', true);
        $this->Cell(10,5, utf8_decode('Acti.'),1, 0, 'C', true);
        $this->Cell(70,5, utf8_decode('Documentos'),1, 0, 'C', true);
        $this->Ln();
	}
