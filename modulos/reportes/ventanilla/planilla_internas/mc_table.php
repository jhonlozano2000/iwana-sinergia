...
class PDF_MC_Table extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(240,7,utf8_decode($OtrasConfiguraciones->get_CoresInternaTitulo()),1, 'R','C');
		$this->Ln();
		$this->Cell(40,7, '','LR',0,'C');
		$this->Cell(240,7,  utf8_decode($OtrasConfiguraciones->get_CoresInternaSubTitulo()),'R',0,'C');
		$this->SetFont('Arial','',9);
		$this->Ln();
		$this->Cell(100,5, utf8_decode('Código: '.$OtrasConfiguraciones->get_CoresInternaCodigo()),1,0,'L');
		$this->Cell(100,5, utf8_decode('Versión: '.$OtrasConfiguraciones->get_CoresInternaVersion()),1,0,'L');
        ...
        $this->Cell(30,5, utf8_decode('Hor. Llegada'),1, 0 , 'C', true);
        $this->Cell(55,5, utf8_decode('Asunto'),1, 0 , 'C', true);
        $this->Cell(40,5, utf8_decode('Destinatarios'),1, 0 , 'C', true);
        $this->Cell(40,5, utf8_decode('Remitente'),1, 0 , 'C', true);
        $this->Cell(20,5, utf8_decode('Fol/Anex'),1, 0 , 'C', true);
        $this->Cell(30,5, utf8_decode('Respon. Nom.'),1, 0 , 'C', true);
        $this->Cell(35,5, utf8_decode('Respon. Fir.'),1, 0 , 'C', true);
        $this->Ln();
    }
