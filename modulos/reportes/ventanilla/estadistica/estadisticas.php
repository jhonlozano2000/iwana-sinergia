                        ...
                        <div class="grid simple">
                            ...
                            <div class="grid-body no-border">
                                ...
                                <div class="col-md-2">
                                    <div class="row-fluid form-group col-md-12">
                                        <div class="input-append success date col-md-10 col-lg-10">
                                            <input type="text" class="form-control" id="sandbox-advance" placeholder="Desde" value="01/01/2018">
                                ...
                                <div class="col-md-2">
                                    <div class="row-fluid form-group col-md-12">
                                        <div class="input-append success date col-md-10 col-lg-10">
                                            <input type="text" class="form-control" id="sandbox-advance1" placeholder="Hasta" value="31/03/2018">
                                            <span class="add-on"><span class="arrow"></span><i class="fa fa-th"></i></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <button class="btn btn-success btn-demo-space" name="BtnConsultar" id="BtnConsultar"> Consultar</button>
                                </div>
                            </div>
                        </div>
                    </div>
