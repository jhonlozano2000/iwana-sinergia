...
require('mc_table_enviado_responsable.php');

$pdf=new PDF_MC_Table('L', 'mm', 'A4');

//set document properties
$pdf->SetAuthor('...::: Iwana :::...');
$pdf->SetTitle('Ventanilla -> Reporte indicadores correspondencia enviada por responsable.');
...
$Regis = ReportRadicacionEnviadoIndicadores::Listar("VER_RESPONSABLE",$FecDesde, $FecHasta, $IdDepen);
