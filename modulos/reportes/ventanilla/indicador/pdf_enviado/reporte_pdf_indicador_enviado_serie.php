...
require('mc_table_enviado_serie.php');

$pdf=new PDF_MC_Table('P', 'mm', 'A4');

//set document properties
$pdf->SetAuthor('...::: Iwana :::...');
$pdf->SetTitle('Ventanilla -> Reporte indicadores correspondencia enviada por serie.');
...
$Regis = ReportRadicacionEnviadoIndicadores::Listar("VER_SERIE",$FecDesde, $FecHasta, $IdDepen);
