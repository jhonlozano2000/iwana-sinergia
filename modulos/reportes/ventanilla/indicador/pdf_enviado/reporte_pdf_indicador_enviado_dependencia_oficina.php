...
require('mc_table_enviado_dependencia_oficina.php');

$pdf=new PDF_MC_Table('P', 'mm', 'A4');

//set document properties
$pdf->SetAuthor('...::: Iwana :::...');
$pdf->SetTitle('Ventanilla -> Reporte indicadores correspondencia enviada por dependencia y oficina.');
...
$Regis = ReportRadicacionEnviadoIndicadores::Listar("VER_DEPENDENCIA_OFICINA",$FecDesde, $FecHasta, $IdDepen);
