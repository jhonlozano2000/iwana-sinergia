...
require('mc_table_enviado_tipo_documento.php');

$pdf=new PDF_MC_Table('P', 'mm', 'A4');

//set document properties
$pdf->SetAuthor('...::: Iwana :::...');
$pdf->SetTitle('Ventanilla -> Reporte indicadores correspondencia enviada por tipo de documento.');
...
$Regis = ReportRadicacionEnviadoIndicadores::Listar("VER_TIPO_DOCUMENTO",$FecDesde, $FecHasta, $IdDepen);
