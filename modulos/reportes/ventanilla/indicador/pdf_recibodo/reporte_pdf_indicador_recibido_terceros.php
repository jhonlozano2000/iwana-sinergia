...
require_once 'mc_table_recibido_terceros.php';
...
$pdf->SetAuthor('...::: Iwana :::...');
$pdf->SetTitle('Ventanilla -> Reporte indicadores correspondencia recibida por tercer.');
...
$Regis = ReportRadicacionRecibidoIndicadores::Listar("VER_TERCEROS", $FecDesde, $FecHasta, $IdDepen);
