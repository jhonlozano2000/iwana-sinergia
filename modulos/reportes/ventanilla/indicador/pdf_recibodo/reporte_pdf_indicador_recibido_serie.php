...
require('mc_table_recibido_serie.php');

$pdf=new PDF_MC_Table('P', 'mm', 'A4');

//set document properties
$pdf->SetAuthor('...::: Iwana :::...');
$pdf->SetTitle('Ventanilla -> Reporte indicadores correspondencia recibida por serie.');
...
$Regis = ReportRadicacionRecibidoIndicadores::Listar("VER_SERIE",$FecDesde, $FecHasta, $IdDepen);
foreach($Regis as $Item){
	$i=0;
	
	$pdf->Row(array($Item['Total'], utf8_decode($Item['nom_serie'])));
}
