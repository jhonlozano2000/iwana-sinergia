...
class PDF_MC_Table extends FPDF
{
	...
	function Header(){
		...
		$this->Ln();
		$this->Cell(280,6, 'Ventanilla -> Reporte indicadores correspondencia recibida por tercero',0,0,'C');
        ...
        $this->Cell(30,5, utf8_decode('# DOCUMENTO'),1, 0, 'C', true);
        $this->Cell(80,5, utf8_decode('CONTACTO'),1, 0, 'C', true);
        $this->Cell(80,5, utf8_decode('RAZON SOCIAL'),1, 0, 'C', true);
