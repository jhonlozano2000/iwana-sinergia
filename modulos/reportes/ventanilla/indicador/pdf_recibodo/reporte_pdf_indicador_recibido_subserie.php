...
require('mc_table_recibido_subserie.php');

$pdf=new PDF_MC_Table('P', 'mm', 'A4');

//set document properties
$pdf->SetAuthor('...::: Iwana :::...');
$pdf->SetTitle('Ventanilla -> Reporte indicadores correspondencia recibida por subserie.');
...
$Regis = ReportRadicacionRecibidoIndicadores::Listar("VER_SUB_SERIE",$FecDesde, $FecHasta, $IdDepen);
