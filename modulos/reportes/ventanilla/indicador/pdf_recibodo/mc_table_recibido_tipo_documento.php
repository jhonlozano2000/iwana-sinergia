...
class PDF_MC_Table extends FPDF
{
	...
	function Header(){
		...
		$this->Ln();
		$this->Cell(190,6, 'Ventanilla -> Reporte indicadores correspondencia recibida por tipo de documento.',0,0,'C');
        ...
        $this->Cell(100,5, utf8_decode('TIPO DE DOCUMENTO'),1, 0, 'C', true);
        $this->Ln();
	}
