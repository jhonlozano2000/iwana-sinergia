...
class PDF_MC_Table extends FPDF
{
	...
	function Header(){
		...
		$this->Ln();
		$this->Cell(280,6, 'Ventanilla -> Reporte indicadores correspondencia interna por destinatario.',0,0,'C');
        ...
        $this->Cell(80,5, utf8_decode('FUNCIONARIO'),1, 0, 'C', true);
        $this->Cell(80,5, utf8_decode('DEPENDENCI'),1, 0, 'C', true);
