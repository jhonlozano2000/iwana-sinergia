...
require('mc_table_interno_subserie.php');

$pdf=new PDF_MC_Table('P', 'mm', 'A4');

//set document properties
$pdf->SetAuthor('...::: Iwana :::...');
$pdf->SetTitle('Ventanilla -> Reporte indicadores correspondencia interna por subserie.');
...
$Regis = ReportRadicacionInternoIndicadores::Listar("VER_SUB_SERIE",$FecDesde, $FecHasta, $IdDepen);
