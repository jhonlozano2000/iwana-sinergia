...
require('mc_table_interno_serie.php');

$pdf=new PDF_MC_Table('P', 'mm', 'A4');

//set document properties
$pdf->SetAuthor('...::: Iwana :::...');
$pdf->SetTitle('Ventanilla -> Reporte indicadores correspondencia interna por serie.');
...
$Regis = ReportRadicacionInternoIndicadores::Listar("VER_SERIE",$FecDesde, $FecHasta, $IdDepen);
