...
class PDF_MC_Table extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(242,7,utf8_decode($OtrasConfiguraciones->get_CoresReciTitulo()),1, 'R','C');
		$this->Ln();
		$this->Cell(40,7, '','LR',0,'C');
		$this->Cell(242,7,  utf8_decode($OtrasConfiguraciones->get_CoresReciSubTitulo()),'R',0,'C');
        ...
        $this->Cell(30,5, utf8_decode('Medio/Recep'),1, 0 , 'C', true);
        $this->Cell(40,5, utf8_decode('Asunto'),1, 0 , 'C', true);
        $this->Cell(40,5, utf8_decode('Responsable'),1, 0 , 'C', true);
        $this->Cell(40,5, utf8_decode('Dependencia'),1, 0 , 'C', true);
