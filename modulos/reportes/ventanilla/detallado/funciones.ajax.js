$(document).ready(function () {
    $("#BtnFlujoPorFuncioEXCEL").click(function () {
        if ($("#tipo_reporte").val() == 0) {
            ...
            if ($("#origen_correspon").val() === "CORRES_RECIBIDA") {
                ...
                setTimeout(function () {
                    url =
                        "reporte_excel_detallado_recibida.php?origen_correspon=" +
                        $("#origen_correspon").val() +
                        "&desde=" +
                        $("#desde").val() +
                        "&hasta=" +
                        $("#hasta").val() +
            ...
            if ($("#origen_correspon").val() === "CORRES_ENVIADA") {
                ...
                setTimeout(function () {
                    url =
                        "reporte_excel_detallado_enviada.php?origen_correspon=" +
                        $("#origen_correspon").val() +
                        "&desde=" +
                        $("#desde").val() +
                        "&hasta=" +
            ...
            if ($("#origen_correspon").val() === "CORRES_INTERNA") {
                ...
                setTimeout(function () {
                    url =
                        "reporte_excel_detallado_interna.php?origen_correspon=" +
                        $("#origen_correspon").val() +
                        "&desde=" +
                        $("#desde").val() +
                        "&hasta=" +
    ...
    $("#BtnFlujoPorFuncioPDF").click(function () {
        if ($("#tipo_reporte").val() == 0) {
            ...
            if ($("#origen_correspon").val() === "CORRES_RECIBIDA") {
                ...
                setTimeout(function () {
                    url =
                        "reporte_pdf_detallado_recibida.php?origen_correspon=" +
                        $("#origen_correspon").val() +
                        "&desde=" +
                        $("#desde").val() +
                        "&hasta=" +
            ...
            if ($("#origen_correspon").val() === "CORRES_ENVIADA") {
                ...
                setTimeout(function () {
                    url =
                        "reporte_pdf_detallado_enviada.php?origen_correspon=" +
                        $("#origen_correspon").val() +
                        "&desde=" +
                        $("#desde").val() +
                        "&hasta=" +
            ...
            if ($("#origen_correspon").val() === "CORRES_INTERNA") {
                ...
                setTimeout(function () {
                    url =
                        "reporte_pdf_detallado_interna.php?origen_correspon=" +
                        $("#origen_correspon").val() +
                        "&desde=" +
                        $("#desde").val() +
                        "&hasta=" +
    ...
    $("#BtnZipConDigitales").click(function () {
        var formData = new FormData($("#frm-datos")[0]);

        $.ajax({
            url: "reporte_zip_con_digitales_recibidas.php",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
            beforeSend: function () {
                $("#DivAlertas").html('<div class="alert alert-info"><button class="close" data-dismiss="alert"></button><a href="#" class="link"><img src="../../../../public/assets/img/loading.gif" width="20" height="20"> Info.:</a> Generando el reporte, por favor espere. </div>');
            },
            success: function (data) {
                ...
                if (elementos[0] == 1) {
                    $("#DivAlertas").html('<div class="alert alert-success"><button class="close" data-dismiss="alert"></button><a href="#" class="link"><i class="fa fa-check"></i> Ok.</a> El reporte se genero correctamente. </div>');
                    //window.open(elementos[1], "Download");
                }
            },
