        ...
        <div class="page-content">
            ...
            <div class="content sm-gutter">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="#" class="active">Reportes, Ventanilla.</a>
                    </li>
                </ul>
                            ...
                            <div class="grid simple">
                                ...
                                <div class="grid-body no-border">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-md-1">
                                            <button class="btn btn-danger btn-xs btn-small" type="button" id="BtnEliminarTercero" name="BtnEliminarTercero">
                                                <i class="fa fa-trash-o"></i>
                                            </button>
                                        </div>

                                        <div class="col-md-3">
                                            <input name="id_funcionario" id="id_funcionario" type="hidden">
                                            <input name="funcionario" type="text" class="form-control" id="funcionario" placeholder="Funcionario">
                                        </div>
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <button class="btn btn-danger btn-xs btn-small" type="button" id="BtnEliminarFuncionario" name="BtnEliminarFuncionario">
                                                <i class="fa fa-trash-o"></i>
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="form-actions">
                                <div class="pull-left">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <button class="btn btn-info btn-cons" type="button" id="BtnReportePQRSF">
                                            <span class="fa fa-search"></span> Generar reporte PQRSF
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid simple ">
                                <div class="grid-body ">
                                    <div class="row form-row">
                                        ...
                                        <div class="col-md-12">
                                            <input name="TxtBusTerceroNaturales" type="text" class="form-control" id="TxtBusTerceroNaturales" placeholder="Ingrese aqui el criterio de búsqueda para el tercero natural.">
                                        </div>
                                    </div>
                                    <div class="row form-row">
                                        <div class="col-md-12">
                            ...
                            <div class="grid simple ">
                                <div class="grid-body ">
                                    <div class="row form-row">
                                        ...
                                        <div class="col-md-12">
                                            <input name="TxtBusTerceroJuridicos" type="text" class="form-control" id="TxtBusTerceroJuridicos" placeholder="Ingrese aqui el criterio de búsqueda para el tercero juridico.">
                                        </div>
                                    </div>
                                    <div class="row form-row">
                                        <div class="col-md-12">
                                            ...
                                            ?>
                                                <tr>
                                                    <td class="v-align-middle">
                                                        <button type="button" class="btn btn-success btn-xs btn-mini llevar_funiconario" id="BtnLlevarFuncionario" data-id_funcio="<?php echo $Item['id_funcio_deta']; ?>" data-num_documento="<?php echo $Item['cod_funcio']; ?>" data-nombres="<?php echo $Item['nom_funcio']; ?>" data-apellidos="<?php echo $Item['ape_funcio']; ?>" data-dismiss="modal">
