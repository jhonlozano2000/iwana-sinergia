...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="../../public/admin_wrap/app-assets/images/pages/login-v2.svg" alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title font-weight-bold mb-1">Bienvenido a PQRS - <?php echo $datosEmpresa->get_RazonSocial(); ?>! 👋</h2>
                                <p class="card-text mb-2">Inicia sesión en tu cuenta o crea una nueva.</p>

                                <div id="divAlerta"></div>
                                <form class="auth-login-form mt-2">
                                    <div class="form-group">
                                        <label class="form-label" for="login">Email</label>
                                        <input class="form-control" id="login" type="text" name="login" placeholder="john@example.com" />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-primary btn-block" id="BtnEntrar">Iniciar sesion</button>
                                </form>
                                <p class="text-center mt-2"><span>¿Nuevo en nuestra plataforma?</span>
                                    <a href="/pqr_registro"><span>&nbsp;Crea una cuenta</span></a>
                                </p>
    ...
    <!-- BEGIN: Page JS-->
    <script src="../../public/admin_wrap/app-assets/js/scripts/pages/page-auth-login.js"></script>
    <!-- END: Page JS-->
    <script src="../../../modulos/pqr_online/redirec.ajax.js"></script>
    <script>
