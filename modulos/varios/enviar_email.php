...
require_once MI_ROOT_RELATIVA . "/config/lib/PHPMailer-master/src/Autoloader.php";
require_once '../../modulos/clases/configuracion/class.ConfigOtras.php';

$ConfiguracionOtras = ConfigOtras::Buscar();

\PHPMailer\PHPMailer\Autoloader::register();
...
switch ($Accion) {
	case 'CORRESPONDENCIA_RECIVIDA':
		...
		//$mail->addAttachment('../envio_email/CERTIFICACION JOHN JAVER LOZANO OK.pdf');
		...
		break;
	case 'CORRESPONDENCIA_RECIVIDA_MASIVA':
