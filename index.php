					...
					<form id="frm_login" class="animated fadeIn">
						<div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
							<div class="col-md-6 col-sm-6 ">
								<input name="login" type="text" class="form-control" id="login" placeholder="Usuario">
							</div>
							<div class="col-md-6 col-sm-6">
								<input name="contra" type="password" class="form-control" id="contra" placeholder="Contraseña">
							</div>
						</div>
						<div class="row p-t-10 m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
							<div class="control-group  col-md-10">
								<button type="button" class="btn btn-primary btn-cons" id="BtnEntrar">Entrar</button>
								<noscript>
									<button type="button" class="btn btn-info btn-cons" id="register_toggle"> Crear una cuenta</button>
