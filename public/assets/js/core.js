...
$(document).ready(function () {
	...
	$('#my-task-list-internas').popover({
        html: true,
        content: function () {
            return $('#notification-list-internas').html();
        }
    });
	
	$('#my-task-list-externa').popover({
        html: true,
        content: function () {
            return $('#notification-list-externa').html();
        }
    });
	
	$('#my-task-list-1').popover({
        html: true,
        content: function () {
            return $('#notification-list-1').html();
        }
    });
